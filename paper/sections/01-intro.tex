...
\begin{itemize}
  ...
  \item \textbf{All zeros to height 2000, on the line.} A complete finite
    Turing verification: the $1517$ nontrivial zeros with
    $0 < \operatorname{Im}\rho \le 2000$ lie exactly on
    $\operatorname{Re} s = \tfrac12$, assembled from thirty-nine band
    certificates whose winding counts are derived from boundary contours, with
