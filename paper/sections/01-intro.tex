...
\begin{itemize}
  ...
  \item \textbf{All zeros to height 1000, on the line.} A complete finite
    Turing verification: the $649$ nontrivial zeros with
    $0 < \operatorname{Im}\rho \le 1000$ lie exactly on
    $\operatorname{Re} s = \tfrac12$, assembled from nineteen band
