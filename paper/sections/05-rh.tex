...
tiles \emph{ten} bands of height $100$ to reach $T = 1000$: all $649$ nontrivial
zeros with $0 < \operatorname{Im}\rho \le 1000$ lie on the critical line. The
per-band windings $(29, 50, 59, 64, 67, 72, 73, 77, 78, 80)$ sum to $649$---the
full classical count to that height---though as before the count is derived from
the boundary contours, not assumed; the independently-computed windings agreeing
band-by-band with the classical census is itself a strong cross-check. (An
