...
$100$, not all of $\mathbb{C}$; Turing's method verifies RH in a region, it does not
prove RH. And it is \emph{conditional on certified numeric input}: the boundary
winding integer ($N = 29$), the twenty-nine exhibited on-line zeros, the edge
...
Turing verification up to height $100$, and it exhibits a third distinct certificate
