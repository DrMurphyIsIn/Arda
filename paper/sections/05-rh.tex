...
largely-built kernel program toward the Riemann--von Mangoldt counting formula.
Each
...
Li's criterion has since joined it in the same prefix-certificate shape.
Building on an external Lean formalization of the upstream
