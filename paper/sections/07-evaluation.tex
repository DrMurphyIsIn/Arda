...
effective de la Vallée-Poussin formalization, the machine-checked
Riemann--von Mangoldt counting formula, the symbolic-in-$n$
proof-complexity lower bound---we mean it as a careful,
...
the \emph{system} and the \emph{formalizations}; the underlying mathematics in
the results and excursion sections is, in each case, attributed to its
originators.
