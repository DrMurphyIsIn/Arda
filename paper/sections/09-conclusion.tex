...
where they \emph{are} (all \ladderCount{} of them to height \ladderHeight{}, exactly on the
...
the Turing verification beyond height \ladderHeight{}, which the height-chain architecture
