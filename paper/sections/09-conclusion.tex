...
The road ahead is marked rather than promised: completing the counting-formula
program (the literal $N(T) = \theta(T)/\pi + 1 + S(T)$, whose one unproved step
is named in \cref{sec:rh}); estimating the explicit
