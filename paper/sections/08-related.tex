...
\cite{axiommath_zetazeros} is a Lean formalization associated with a
Montgomery--Taylor extremal-kernel argument; two of Telperion's emitters port a
\emph{proof idea} from it---an extremum-at-the-boundary move and a transcendental
enclosure atom---independently re-implemented in our idiom. Conflating the
