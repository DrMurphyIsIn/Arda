...
# 2026-09-19 (RH_weil_window_floor_of_certified_block): the Zhu compact-window import.
# The WeilForm namespace is a VERBATIM mirror of
# examples/weil_form_enclosure/lean/WeilFormDefs.lean (gated by that island's generate.py
# --check); WeilWindow adds the window-floor vocabulary and the four undischarged inputs of
# Zhu Thm 1.1 as OPAQUE predicates.  Memo: docs/ZHU_WINDOW_POSITIVITY_IMPORT_2026-09-19.md.
WEIL_WINDOW_BLOCK = """
namespace WeilForm
open WeilExplicit
...
""",
    ...
    BOMBIERI_LAGARIAS_BLOCK,
    # ===== MIRROR + AUTHORED (2026-09-19 Zhu window import): WeilForm (verbatim island mirror)
    # and WeilWindow (window floor, comb mass, threshold, and the four opaque undischarged inputs)
    WEIL_WINDOW_BLOCK,
]
