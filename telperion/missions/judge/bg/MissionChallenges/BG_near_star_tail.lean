/- DO NOT EDIT BY HAND -- generated by telperion.missions.judge.
   Comparator CHALLENGE for registry node bg/BG_near_star_tail.
   The TYPE below is the registered statement, missions/bg/lean/Statements/
   BG_near_star_tail.lean (header sha256 414c614a85420809), binders and conclusion verbatim; the
   PROOF is the artifact constant `R3Cert.nearStar_nonpos` from R3Cert.NearStar. Both kernels
...
theorem _root_.MissionJudge.BG_near_star_tail :
    ∀ (c k : ℕ), logPhi (nearStarB c k) ≤ 0 :=
  R3Cert.nearStar_nonpos
