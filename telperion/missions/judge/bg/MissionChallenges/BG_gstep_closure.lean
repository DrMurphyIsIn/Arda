/- DO NOT EDIT BY HAND -- generated by telperion.missions.judge.
   Comparator CHALLENGE for registry node bg/BG_gstep_closure.
   The TYPE below is the registered statement, missions/bg/lean/Statements/
   BG_gstep_closure.lean (header sha256 8f3e788d1953deb2), binders and conclusion verbatim; the
   PROOF is the artifact constant `R3Cert.CappedJointConfig.gstep_le_one_achievable` from R3Cert.CappedJointClosure. Both kernels
...
theorem _root_.MissionJudge.BG_gstep_closure :
    ∀ (l : List ℚ) (hl : ∀ μ ∈ l, Achievable μ), (baseOf l) ^ 11 * prodBcap l / (W * (5 / 3) ^ 11) ≤ 1 :=
  R3Cert.CappedJointConfig.gstep_le_one_achievable
