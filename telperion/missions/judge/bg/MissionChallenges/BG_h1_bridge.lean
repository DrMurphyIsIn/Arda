/- DO NOT EDIT BY HAND -- generated by telperion.missions.judge.
   Comparator CHALLENGE for registry node bg/BG_h1_bridge.
   The TYPE below is the registered statement, missions/bg/lean/Statements/
   BG_h1_bridge.lean (header sha256 8ae71d694f9114fe), binders and conclusion verbatim; the
   PROOF is the artifact constant `R3Cert.Step3.pi_utree` from R3Cert.R47Tree. Both kernels
...
theorem _root_.MissionJudge.BG_h1_bridge :
    ∀ (t : UTree), (lapl (aGraph (realize (dtRealize t)))).permanent
        / (∏ v, ((aGraph (realize (dtRealize t))).degree v : ℝ))
      = Aobj t :=
  R3Cert.Step3.pi_utree
