/- DO NOT EDIT BY HAND -- generated by telperion.missions.judge.
   Comparator CHALLENGE for registry node bg/BG_near_star_tie.
   The TYPE below is the registered statement, missions/bg/lean/Statements/
   BG_near_star_tie.lean (header sha256 9d6e0d4c9e856484), binders and conclusion verbatim; the
   PROOF is the artifact constant `R3Cert.nearStar_tie` from R3Cert.NearStar. Both kernels
...
theorem _root_.MissionJudge.BG_near_star_tie :
    ∀ (c k : ℕ) (h : c + k = 5), logPhi (nearStarB c k) = 0 :=
  R3Cert.nearStar_tie
