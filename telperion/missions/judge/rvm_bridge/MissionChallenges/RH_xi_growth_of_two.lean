/- DO NOT EDIT BY HAND -- generated by telperion.missions.judge.
   Comparator CHALLENGE for registry node rh/RH_xi_growth_of_two.
   The TYPE below is the registered statement, missions/rh/lean/Statements/
   RH_xi_growth_of_two.lean (header sha256 ca559265f09a9448), binders and conclusion verbatim; the
   PROOF is the artifact constant `RvMBridge22.xiDiffExtGrowthRight_of_two` from E6Bridge22. Both kernels
...
theorem _root_.MissionJudge.RH_xi_growth_of_two :
    ∀ (h1 : LocalCountSum) (h2 : StripDerivBound), XiDiffExtGrowthRight :=
  RvMBridge22.xiDiffExtGrowthRight_of_two
