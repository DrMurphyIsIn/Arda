/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 2000000),(1999999 / 2000000)] x [1900,1950]` with `N = 46` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (1925)*I`, radius `R = Real.sqrt ((14825001999998000001 / 8000000000000))`,
...
namespace RHInBox_1d2000000_1999999d2000000_1900_1950

/-- Chosen Blaschke ball center for the box `[(1 / 2000000),(1999999 / 2000000)] x [1900,1950]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (1925)⟩

/-- Chosen Blaschke ball radius (squared radius `(14825001999998000001 / 8000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((14825001999998000001 / 8000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 2000000),(1999999 / 2000000)] x [1900,1950]` with `N = 46`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (1925)*I`, `R = Real.sqrt ((14825001999998000001 / 8000000000000))`, and count `N = 46`.  Takes the
    documented Arb inputs `hLine` (the 46 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*46`).  conjecture1_proved = False. -/
theorem rh_in_box_1d2000000_1999999d2000000_1900_1950
    (hLine : ∃ x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21 x22 x23 x24 x25 x26 x27 x28 x29 x30 x31 x32 x33 x34 x35 x36 x37 x38 x39 x40 x41 x42 x43 x44 x45 x46 : ℝ,
      (1900 ≤ x1 ∧ x1 < x2 ∧ x2 < x3 ∧ x3 < x4 ∧ x4 < x5 ∧ x5 < x6 ∧ x6 < x7 ∧ x7 < x8 ∧ x8 < x9 ∧ x9 < x10 ∧ x10 < x11 ∧ x11 < x12 ∧ x12 < x13 ∧ x13 < x14 ∧ x14 < x15 ∧ x15 < x16 ∧ x16 < x17 ∧ x17 < x18 ∧ x18 < x19 ∧ x19 < x20 ∧ x20 < x21 ∧ x21 < x22 ∧ x22 < x23 ∧ x23 < x24 ∧ x24 < x25 ∧ x25 < x26 ∧ x26 < x27 ∧ x27 < x28 ∧ x28 < x29 ∧ x29 < x30 ∧ x30 < x31 ∧ x31 < x32 ∧ x32 < x33 ∧ x33 < x34 ∧ x34 < x35 ∧ x35 < x36 ∧ x36 < x37 ∧ x37 < x38 ∧ x38 < x39 ∧ x39 < x40 ∧ x40 < x41 ∧ x41 < x42 ∧ x42 < x43 ∧ x43 < x44 ∧ x44 < x45 ∧ x45 < x46 ∧ x46 ≤ 1950) ∧
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      DifferentiableOn ℂ E (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((1900) : ℝ) (1950)) →
      ...
      (∀ x ∈ Set.uIcc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)), riemannZeta (↑x + (((1950) : ℝ) : ℂ) * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((1900) : ℝ) (1950), riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((1900) : ℝ) (1950), riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ ρ ∈ s, (((1 / 2000000)) : ℝ) < ρ.re ∧ ρ.re < ((1999999 / 2000000)) ∧ ((1900) : ℝ) < ρ.im ∧ ρ.im < (1950)) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun x : ℝ => ((↑x + (((1900) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun x : ℝ => ((↑x + (((1950) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1900)) ((1950))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1900)) ((1950))) ∧
      (IntervalIntegrable
        (fun x : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((↑x + (((1900) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable
        (fun x : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((↑x + (((1950) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1900)) ((1950))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1900)) ((1950))) ∧
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((1900) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((1950) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1900)) ((1950))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1900)) ((1950))) ∧
      ((∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((1900) : ℝ) : ℂ) * I))
          - (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((1950) : ℝ) : ℂ) * I))
          + I • (∫ y in ((1900) : ℝ)..(1950), logDeriv riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I))
          - I • (∫ y in ((1900) : ℝ)..(1950), logDeriv riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I))
        = 2 * π * I * (46 : ℂ))) :
    (∀ ρ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) → (((1900) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (1950)) →
      riemannZeta ρ = 0 → ρ.re = 1 / 2) := by
  have hRpos : (0 : ℝ) < RPB := RPB_pos
  have hsig : (((1 / 2000000)) : ℝ) ≤ ((1999999 / 2000000)) := by norm_num
  have hTle : ((1900) : ℝ) ≤ (1950) := by norm_num
  have hbox_ball : ∀ ρ : ℂ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) →
      (((1900) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (1950)) → ρ ∈ Metric.ball cPB RPB := by
    intro ρ hre him
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    apply Real.sqrt_lt_sqrt (by positivity)
    have h1 := hre.1; have h2 := hre.2; have h3 := him.1; have h4 := him.2
    nlinarith [h1, h2, h3, h4, sq_nonneg (ρ.re - ((1 / 2))), sq_nonneg (ρ.im - (1925))]
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    intro hlt
    simp only [Complex.one_re, Complex.one_im] at hlt
    have hle : Real.sqrt ((14825001999998000001 / 8000000000000)) ≤
        Real.sqrt (((1 : ℝ) - ((1 / 2))) ^ 2 + ((0 : ℝ) - (1925)) ^ 2) :=
      Real.sqrt_le_sqrt (by norm_num)
    linarith [hlt, hle]
  obtain ⟨x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39, x40, x41, x42, x43, x44, x45, x46, ⟨hlo, hc12, hc23, hc34, hc45, hc56, hc67, hc78, hc89, hc910, hc1011, hc1112, hc1213, hc1314, hc1415, hc1516, hc1617, hc1718, hc1819, hc1920, hc2021, hc2122, hc2223, hc2324, hc2425, hc2526, hc2627, hc2728, hc2829, hc2930, hc3031, hc3132, hc3233, hc3334, hc3435, hc3536, hc3637, hc3738, hc3839, hc3940, hc4041, hc4142, hc4243, hc4344, hc4445, hc4546, hhi⟩, hΛ1, hΛ2, hΛ3, hΛ4, hΛ5, hΛ6, hΛ7, hΛ8, hΛ9, hΛ10, hΛ11, hΛ12, hΛ13, hΛ14, hΛ15, hΛ16, hΛ17, hΛ18, hΛ19, hΛ20, hΛ21, hΛ22, hΛ23, hΛ24, hΛ25, hΛ26, hΛ27, hΛ28, hΛ29, hΛ30, hΛ31, hΛ32, hΛ33, hΛ34, hΛ35, hΛ36, hΛ37, hΛ38, hΛ39, hΛ40, hΛ41, hΛ42, hΛ43, hΛ44, hΛ45, hΛ46⟩ := hLine
  ...
  set xsL : List ℝ := [x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39, x40, x41, x42, x43, x44, x45, x46] with hxsdef
  have hchain : xsL.IsChain (· < ·) := by
    rw [hxsdef]
    simp only [List.isChain_cons_cons]
    exact ⟨hc12, hc23, hc34, hc45, hc56, hc67, hc78, hc89, hc910, hc1011, hc1112, hc1213, hc1314, hc1415, hc1516, hc1617, hc1718, hc1819, hc1920, hc2021, hc2122, hc2223, hc2324, hc2425, hc2526, hc2627, hc2728, hc2829, hc2930, hc3031, hc3132, hc3233, hc3334, hc3435, hc3536, hc3637, hc3738, hc3839, hc3940, hc4041, hc4142, hc4243, hc4344, hc4445, hc4546, List.IsChain.singleton _⟩
  set T : Finset ℂ :=
  ...
  have hu46 : x46 ≤ ((1950) : ℝ) := hhi
  have hu45 : x45 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc4546) hu46
  have hu44 : x44 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc4445) hu45
  have hu43 : x43 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc4344) hu44
  have hu42 : x42 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc4243) hu43
  have hu41 : x41 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc4142) hu42
  have hu40 : x40 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc4041) hu41
  have hu39 : x39 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3940) hu40
  have hu38 : x38 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3839) hu39
  have hu37 : x37 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3738) hu38
  have hu36 : x36 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3637) hu37
  have hu35 : x35 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3536) hu36
  have hu34 : x34 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3435) hu35
  have hu33 : x33 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3334) hu34
  have hu32 : x32 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3233) hu33
  have hu31 : x31 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3132) hu32
  have hu30 : x30 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc3031) hu31
  have hu29 : x29 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2930) hu30
  have hu28 : x28 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2829) hu29
  have hu27 : x27 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2728) hu28
  have hu26 : x26 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2627) hu27
  have hu25 : x25 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2526) hu26
  have hu24 : x24 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2425) hu25
  have hu23 : x23 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2324) hu24
  have hu22 : x22 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2223) hu23
  have hu21 : x21 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2122) hu22
  have hu20 : x20 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc2021) hu21
  have hu19 : x19 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1920) hu20
  have hu18 : x18 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1819) hu19
  have hu17 : x17 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1718) hu18
  have hu16 : x16 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1617) hu17
  have hu15 : x15 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1516) hu16
  have hu14 : x14 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1415) hu15
  have hu13 : x13 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1314) hu14
  have hu12 : x12 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1213) hu13
  have hu11 : x11 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1112) hu12
  have hu10 : x10 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc1011) hu11
  have hu9 : x9 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc910) hu10
  have hu8 : x8 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc89) hu9
  have hu7 : x7 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc78) hu8
  have hu6 : x6 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc67) hu7
  have hu5 : x5 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc56) hu6
  have hu4 : x4 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc45) hu5
  have hu3 : x3 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc34) hu4
  have hu2 : x2 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc23) hu3
  have hu1 : x1 ≤ ((1950) : ℝ) := le_trans (le_of_lt hc12) hu2
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (1900) (1950) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((1900) : ℝ) (1950)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((1900) : ℝ) : ℂ) * I))
        ...
        - I • (∫ y in ((1900) : ℝ)..(1950), logDeriv riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((46 : ℤ) : ℂ) := by
    rw [show (((46 : ℤ) : ℂ)) = (46 : ℂ) by norm_num]; exact hwindA
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((1950) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1900)) ((1950))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1900)) ((1950))) := by
  ...
  have hcountN : (46 : ℤ) = (T.card : ℤ) := by rw [hTcard]; norm_num
  exact RHInBox.rh_in_box_of_certificate (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (1900) (1950) cPB RPB 46
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d2000000_1999999d2000000_1900_1950
