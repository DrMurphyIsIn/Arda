/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 2000000),(1999999 / 2000000)] x [2480,2520]` with `N = 38` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (2500)*I`, radius `R = Real.sqrt ((25001601999998000001 / 8000000000000))`,
...
namespace RHInBox_1d2000000_1999999d2000000_2480_2520

/-- Chosen Blaschke ball center for the box `[(1 / 2000000),(1999999 / 2000000)] x [2480,2520]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (2500)⟩

/-- Chosen Blaschke ball radius (squared radius `(25001601999998000001 / 8000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((25001601999998000001 / 8000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 2000000),(1999999 / 2000000)] x [2480,2520]` with `N = 38`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (2500)*I`, `R = Real.sqrt ((25001601999998000001 / 8000000000000))`, and count `N = 38`.  Takes the
    documented Arb inputs `hLine` (the 38 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*38`).  conjecture1_proved = False. -/
theorem rh_in_box_1d2000000_1999999d2000000_2480_2520
    (hLine : ∃ x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21 x22 x23 x24 x25 x26 x27 x28 x29 x30 x31 x32 x33 x34 x35 x36 x37 x38 : ℝ,
      (2480 ≤ x1 ∧ x1 < x2 ∧ x2 < x3 ∧ x3 < x4 ∧ x4 < x5 ∧ x5 < x6 ∧ x6 < x7 ∧ x7 < x8 ∧ x8 < x9 ∧ x9 < x10 ∧ x10 < x11 ∧ x11 < x12 ∧ x12 < x13 ∧ x13 < x14 ∧ x14 < x15 ∧ x15 < x16 ∧ x16 < x17 ∧ x17 < x18 ∧ x18 < x19 ∧ x19 < x20 ∧ x20 < x21 ∧ x21 < x22 ∧ x22 < x23 ∧ x23 < x24 ∧ x24 < x25 ∧ x25 < x26 ∧ x26 < x27 ∧ x27 < x28 ∧ x28 < x29 ∧ x29 < x30 ∧ x30 < x31 ∧ x31 < x32 ∧ x32 < x33 ∧ x33 < x34 ∧ x34 < x35 ∧ x35 < x36 ∧ x36 < x37 ∧ x37 < x38 ∧ x38 ≤ 2520) ∧
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      DifferentiableOn ℂ E (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((2480) : ℝ) (2520)) →
      (∀ z ∈ Metric.ball cPB RPB, riemannZeta z ≠ 0 →
        logDeriv riemannZeta z = (∑ ρ ∈ s, (d ρ : ℂ) / (z - ρ)) + E z) →
      (∀ x ∈ Set.uIcc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)), riemannZeta (↑x + (((2480) : ℝ) : ℂ) * I) ≠ 0) ∧
      (∀ x ∈ Set.uIcc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)), riemannZeta (↑x + (((2520) : ℝ) : ℂ) * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((2480) : ℝ) (2520), riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((2480) : ℝ) (2520), riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ ρ ∈ s, (((1 / 2000000)) : ℝ) < ρ.re ∧ ρ.re < ((1999999 / 2000000)) ∧ ((2480) : ℝ) < ρ.im ∧ ρ.im < (2520)) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun x : ℝ => ((↑x + (((2480) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun x : ℝ => ((↑x + (((2520) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((2480)) ((2520))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((2480)) ((2520))) ∧
      (IntervalIntegrable
        (fun x : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((↑x + (((2480) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable
        (fun x : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((↑x + (((2520) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((2480)) ((2520))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((2480)) ((2520))) ∧
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((2480) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((2520) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((2480)) ((2520))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((2480)) ((2520))) ∧
      ((∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((2480) : ℝ) : ℂ) * I))
          - (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((2520) : ℝ) : ℂ) * I))
          + I • (∫ y in ((2480) : ℝ)..(2520), logDeriv riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I))
          - I • (∫ y in ((2480) : ℝ)..(2520), logDeriv riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I))
        = 2 * π * I * (38 : ℂ))) :
    (∀ ρ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) → (((2480) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (2520)) →
      riemannZeta ρ = 0 → ρ.re = 1 / 2) := by
  have hRpos : (0 : ℝ) < RPB := RPB_pos
  have hsig : (((1 / 2000000)) : ℝ) ≤ ((1999999 / 2000000)) := by norm_num
  have hTle : ((2480) : ℝ) ≤ (2520) := by norm_num
  have hbox_ball : ∀ ρ : ℂ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) →
      (((2480) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (2520)) → ρ ∈ Metric.ball cPB RPB := by
    intro ρ hre him
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    apply Real.sqrt_lt_sqrt (by positivity)
    have h1 := hre.1; have h2 := hre.2; have h3 := him.1; have h4 := him.2
    nlinarith [h1, h2, h3, h4, sq_nonneg (ρ.re - ((1 / 2))), sq_nonneg (ρ.im - (2500))]
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    intro hlt
    simp only [Complex.one_re, Complex.one_im] at hlt
    have hle : Real.sqrt ((25001601999998000001 / 8000000000000)) ≤
        Real.sqrt (((1 : ℝ) - ((1 / 2))) ^ 2 + ((0 : ℝ) - (2500)) ^ 2) :=
  ...
  have hTcard : T.card = 38 := by
    ...
    rfl
  have hb1 : ((2480) : ℝ) ≤ x1 := hlo
  have hb2 : ((2480) : ℝ) ≤ x2 := le_trans hb1 (le_of_lt hc12)
  have hb3 : ((2480) : ℝ) ≤ x3 := le_trans hb2 (le_of_lt hc23)
  have hb4 : ((2480) : ℝ) ≤ x4 := le_trans hb3 (le_of_lt hc34)
  have hb5 : ((2480) : ℝ) ≤ x5 := le_trans hb4 (le_of_lt hc45)
  have hb6 : ((2480) : ℝ) ≤ x6 := le_trans hb5 (le_of_lt hc56)
  have hb7 : ((2480) : ℝ) ≤ x7 := le_trans hb6 (le_of_lt hc67)
  have hb8 : ((2480) : ℝ) ≤ x8 := le_trans hb7 (le_of_lt hc78)
  have hb9 : ((2480) : ℝ) ≤ x9 := le_trans hb8 (le_of_lt hc89)
  have hb10 : ((2480) : ℝ) ≤ x10 := le_trans hb9 (le_of_lt hc910)
  have hb11 : ((2480) : ℝ) ≤ x11 := le_trans hb10 (le_of_lt hc1011)
  have hb12 : ((2480) : ℝ) ≤ x12 := le_trans hb11 (le_of_lt hc1112)
  have hb13 : ((2480) : ℝ) ≤ x13 := le_trans hb12 (le_of_lt hc1213)
  have hb14 : ((2480) : ℝ) ≤ x14 := le_trans hb13 (le_of_lt hc1314)
  have hb15 : ((2480) : ℝ) ≤ x15 := le_trans hb14 (le_of_lt hc1415)
  have hb16 : ((2480) : ℝ) ≤ x16 := le_trans hb15 (le_of_lt hc1516)
  have hb17 : ((2480) : ℝ) ≤ x17 := le_trans hb16 (le_of_lt hc1617)
  have hb18 : ((2480) : ℝ) ≤ x18 := le_trans hb17 (le_of_lt hc1718)
  have hb19 : ((2480) : ℝ) ≤ x19 := le_trans hb18 (le_of_lt hc1819)
  have hb20 : ((2480) : ℝ) ≤ x20 := le_trans hb19 (le_of_lt hc1920)
  have hb21 : ((2480) : ℝ) ≤ x21 := le_trans hb20 (le_of_lt hc2021)
  have hb22 : ((2480) : ℝ) ≤ x22 := le_trans hb21 (le_of_lt hc2122)
  have hb23 : ((2480) : ℝ) ≤ x23 := le_trans hb22 (le_of_lt hc2223)
  have hb24 : ((2480) : ℝ) ≤ x24 := le_trans hb23 (le_of_lt hc2324)
  have hb25 : ((2480) : ℝ) ≤ x25 := le_trans hb24 (le_of_lt hc2425)
  have hb26 : ((2480) : ℝ) ≤ x26 := le_trans hb25 (le_of_lt hc2526)
  have hb27 : ((2480) : ℝ) ≤ x27 := le_trans hb26 (le_of_lt hc2627)
  have hb28 : ((2480) : ℝ) ≤ x28 := le_trans hb27 (le_of_lt hc2728)
  have hb29 : ((2480) : ℝ) ≤ x29 := le_trans hb28 (le_of_lt hc2829)
  have hb30 : ((2480) : ℝ) ≤ x30 := le_trans hb29 (le_of_lt hc2930)
  have hb31 : ((2480) : ℝ) ≤ x31 := le_trans hb30 (le_of_lt hc3031)
  have hb32 : ((2480) : ℝ) ≤ x32 := le_trans hb31 (le_of_lt hc3132)
  have hb33 : ((2480) : ℝ) ≤ x33 := le_trans hb32 (le_of_lt hc3233)
  have hb34 : ((2480) : ℝ) ≤ x34 := le_trans hb33 (le_of_lt hc3334)
  have hb35 : ((2480) : ℝ) ≤ x35 := le_trans hb34 (le_of_lt hc3435)
  have hb36 : ((2480) : ℝ) ≤ x36 := le_trans hb35 (le_of_lt hc3536)
  have hb37 : ((2480) : ℝ) ≤ x37 := le_trans hb36 (le_of_lt hc3637)
  have hb38 : ((2480) : ℝ) ≤ x38 := le_trans hb37 (le_of_lt hc3738)
  have hu38 : x38 ≤ ((2520) : ℝ) := hhi
  have hu37 : x37 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc3738) hu38
  have hu36 : x36 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc3637) hu37
  have hu35 : x35 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc3536) hu36
  have hu34 : x34 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc3435) hu35
  have hu33 : x33 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc3334) hu34
  have hu32 : x32 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc3233) hu33
  have hu31 : x31 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc3132) hu32
  have hu30 : x30 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc3031) hu31
  have hu29 : x29 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2930) hu30
  have hu28 : x28 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2829) hu29
  have hu27 : x27 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2728) hu28
  have hu26 : x26 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2627) hu27
  have hu25 : x25 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2526) hu26
  have hu24 : x24 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2425) hu25
  have hu23 : x23 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2324) hu24
  have hu22 : x22 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2223) hu23
  have hu21 : x21 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2122) hu22
  have hu20 : x20 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc2021) hu21
  have hu19 : x19 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1920) hu20
  have hu18 : x18 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1819) hu19
  have hu17 : x17 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1718) hu18
  have hu16 : x16 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1617) hu17
  have hu15 : x15 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1516) hu16
  have hu14 : x14 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1415) hu15
  have hu13 : x13 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1314) hu14
  have hu12 : x12 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1213) hu13
  have hu11 : x11 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1112) hu12
  have hu10 : x10 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc1011) hu11
  have hu9 : x9 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc910) hu10
  have hu8 : x8 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc89) hu9
  have hu7 : x7 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc78) hu8
  have hu6 : x6 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc67) hu7
  have hu5 : x5 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc56) hu6
  have hu4 : x4 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc45) hu5
  have hu3 : x3 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc34) hu4
  have hu2 : x2 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc23) hu3
  have hu1 : x1 ≤ ((2520) : ℝ) := le_trans (le_of_lt hc12) hu2
  ...
  have hTbox : ∀ z ∈ T, ((((1 / 2000000)) : ℝ) ≤ z.re ∧ z.re ≤ ((1999999 / 2000000))) ∧ (((2480) : ℝ) ≤ z.im ∧ z.im ≤ (2520)) := by
    rw [hTdef]
    refine RHInBox.line_toFinset_forall xsL ?_
    rw [hxsdef]
    simp only [List.forall_mem_cons]
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (2480) (2520) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((2480) : ℝ) (2520)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((2480) : ℝ) : ℂ) * I))
        - (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((2520) : ℝ) : ℂ) * I))
        + I • (∫ y in ((2480) : ℝ)..(2520), logDeriv riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I))
        - I • (∫ y in ((2480) : ℝ)..(2520), logDeriv riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((38 : ℤ) : ℂ) := by
  ...
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((2520) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((2480)) ((2520))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((2480)) ((2520))) := by
  ...
  exact RHInBox.rh_in_box_of_certificate (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (2480) (2520) cPB RPB 38
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d2000000_1999999d2000000_2480_2520
