/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 2000000),(1999999 / 2000000)] x [0,100]` with `N = 29` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (50)*I`, radius `R = Real.sqrt ((20001999998000001 / 8000000000000))`,
...
namespace RHInBox_1d2000000_1999999d2000000_0_100

/-- Chosen Blaschke ball center for the box `[(1 / 2000000),(1999999 / 2000000)] x [0,100]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (50)⟩

/-- Chosen Blaschke ball radius (squared radius `(20001999998000001 / 8000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((20001999998000001 / 8000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 2000000),(1999999 / 2000000)] x [0,100]` with `N = 29`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (50)*I`, `R = Real.sqrt ((20001999998000001 / 8000000000000))`, and count `N = 29`.  Takes the
    documented Arb inputs `hLine` (the 29 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*29`).  conjecture1_proved = False. -/
theorem rh_in_box_1d2000000_1999999d2000000_0_100
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      ...
      ((∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((0) : ℝ) : ℂ) * I))
        ...
        = 2 * π * I * (29 : ℂ))) :
    (∀ ρ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) → (((0) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (100)) →
  ...
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    ...
    have hle : Real.sqrt ((20001999998000001 / 8000000000000)) ≤
  ...
  have hTzero : ∀ z ∈ T, riemannZeta z = 0 := by
    ...
    · exact hzeta _ hΛ28
    · exact hzeta _ hΛ29
  have hTbox : ∀ z ∈ T, ((((1 / 2000000)) : ℝ) ≤ z.re ∧ z.re ≤ ((1999999 / 2000000))) ∧ (((0) : ℝ) ≤ z.im ∧ z.im ≤ (100)) := by
    rw [hTdef]
    refine RHInBox.line_toFinset_forall xsL ?_
    intro t ht
    refine ⟨⟨?_, ?_⟩, ?_, ?_⟩
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (0) (100) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((0) : ℝ) (100)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((0) : ℝ) : ℂ) * I))
        - (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((100) : ℝ) : ℂ) * I))
        + I • (∫ y in ((0) : ℝ)..(100), logDeriv riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I))
        - I • (∫ y in ((0) : ℝ)..(100), logDeriv riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((29 : ℤ) : ℂ) := by
  ...
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((100) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((0)) ((100))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((0)) ((100))) := by
  ...
  exact RHInBox.rh_in_box_of_certificate (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (0) (100) cPB RPB 29
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d2000000_1999999d2000000_0_100
