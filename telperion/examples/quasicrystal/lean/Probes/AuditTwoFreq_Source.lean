/-  AUDIT PROBE A2 (2026-09-22), node MM_torus_section_dictionary: the artifact's ONLY island
    input is the definition `twoFreq` from TwoFreqRigidity.lean (and the sibling rung consumes
    `twoFreq_realRooted_iff`).  Between the markers this file is TwoFreqRigidity.lean VERBATIM,
    re-elaborated from source; the trailing block prints the axiom sets.  Run by hand with

        cd telperion/examples/quasicrystal/lean && lake env lean Probes/AuditTwoFreq_Source.lean

    conjecture1_proved = False.
    ===== BEGIN TwoFreqRigidity.lean VERBATIM ===== -/
/-
...
-- ===== END TwoFreqRigidity.lean VERBATIM; AUDIT PROBE A2 prints follow =====
