/-  Probes/RSDesign_theta.lean -- calibration brick for the Riemann-Siegel (A3) design memo:
    a HEIGHT-UNIFORM kernel enclosure of the Riemann-Siegel phase, and one instance at t = 280000.
    ...
    Calibration (this file, 2026-09-23): 646 lines, two compile iterations; `lake env lean` about
    20 s wall of which kernel type checking is 0.33 s and `norm_num` elaboration 4.7 s.
