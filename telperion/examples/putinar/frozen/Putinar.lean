/- telperion 0.1.6 | family Putinar | input-hash 0fcb54a29adfc8b3
...
-- putinar_x2y_plus_y: Putinar certificate  p = σ_0 + Σ σ_i·g_i (SOS multipliers) on the constraint set.
...
-- putinar_x_plus_y: Putinar certificate  p = σ_0 + Σ σ_i·g_i (SOS multipliers) on the constraint set.
