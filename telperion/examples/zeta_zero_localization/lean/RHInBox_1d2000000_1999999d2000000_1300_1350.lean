/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 2000000),(1999999 / 2000000)] x [1300,1350]` with `N = 43` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (1325)*I`, radius `R = Real.sqrt ((7025001999998000001 / 8000000000000))`,
...
namespace RHInBox_1d2000000_1999999d2000000_1300_1350

/-- Chosen Blaschke ball center for the box `[(1 / 2000000),(1999999 / 2000000)] x [1300,1350]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (1325)⟩

/-- Chosen Blaschke ball radius (squared radius `(7025001999998000001 / 8000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((7025001999998000001 / 8000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 2000000),(1999999 / 2000000)] x [1300,1350]` with `N = 43`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (1325)*I`, `R = Real.sqrt ((7025001999998000001 / 8000000000000))`, and count `N = 43`.  Takes the
    documented Arb inputs `hLine` (the 43 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*43`).  conjecture1_proved = False. -/
theorem rh_in_box_1d2000000_1999999d2000000_1300_1350
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      DifferentiableOn ℂ E (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((1300) : ℝ) (1350)) →
      ...
      (∀ x ∈ Set.uIcc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)), riemannZeta (↑x + (((1350) : ℝ) : ℂ) * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((1300) : ℝ) (1350), riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((1300) : ℝ) (1350), riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ ρ ∈ s, (((1 / 2000000)) : ℝ) < ρ.re ∧ ρ.re < ((1999999 / 2000000)) ∧ ((1300) : ℝ) < ρ.im ∧ ρ.im < (1350)) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun x : ℝ => ((↑x + (((1300) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun x : ℝ => ((↑x + (((1350) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1300)) ((1350))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1300)) ((1350))) ∧
      (IntervalIntegrable
        (fun x : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((↑x + (((1300) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable
        (fun x : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((↑x + (((1350) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1300)) ((1350))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1300)) ((1350))) ∧
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((1300) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((1350) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1300)) ((1350))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1300)) ((1350))) ∧
      ((∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((1300) : ℝ) : ℂ) * I))
          - (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((1350) : ℝ) : ℂ) * I))
          + I • (∫ y in ((1300) : ℝ)..(1350), logDeriv riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I))
          - I • (∫ y in ((1300) : ℝ)..(1350), logDeriv riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I))
        = 2 * π * I * (43 : ℂ))) :
    (∀ ρ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) → (((1300) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (1350)) →
      riemannZeta ρ = 0 → ρ.re = 1 / 2) := by
  have hRpos : (0 : ℝ) < RPB := RPB_pos
  have hsig : (((1 / 2000000)) : ℝ) ≤ ((1999999 / 2000000)) := by norm_num
  have hTle : ((1300) : ℝ) ≤ (1350) := by norm_num
  have hbox_ball : ∀ ρ : ℂ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) →
      (((1300) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (1350)) → ρ ∈ Metric.ball cPB RPB := by
    intro ρ hre him
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    apply Real.sqrt_lt_sqrt (by positivity)
    have h1 := hre.1; have h2 := hre.2; have h3 := him.1; have h4 := him.2
    nlinarith [h1, h2, h3, h4, sq_nonneg (ρ.re - ((1 / 2))), sq_nonneg (ρ.im - (1325))]
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    intro hlt
    simp only [Complex.one_re, Complex.one_im] at hlt
    have hle : Real.sqrt ((7025001999998000001 / 8000000000000)) ≤
        Real.sqrt (((1 : ℝ) - ((1 / 2))) ^ 2 + ((0 : ℝ) - (1325)) ^ 2) :=
  ...
  have hu43 : x43 ≤ ((1350) : ℝ) := hhi
  have hu42 : x42 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc4243) hu43
  have hu41 : x41 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc4142) hu42
  have hu40 : x40 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc4041) hu41
  have hu39 : x39 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3940) hu40
  have hu38 : x38 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3839) hu39
  have hu37 : x37 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3738) hu38
  have hu36 : x36 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3637) hu37
  have hu35 : x35 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3536) hu36
  have hu34 : x34 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3435) hu35
  have hu33 : x33 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3334) hu34
  have hu32 : x32 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3233) hu33
  have hu31 : x31 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3132) hu32
  have hu30 : x30 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc3031) hu31
  have hu29 : x29 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2930) hu30
  have hu28 : x28 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2829) hu29
  have hu27 : x27 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2728) hu28
  have hu26 : x26 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2627) hu27
  have hu25 : x25 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2526) hu26
  have hu24 : x24 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2425) hu25
  have hu23 : x23 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2324) hu24
  have hu22 : x22 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2223) hu23
  have hu21 : x21 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2122) hu22
  have hu20 : x20 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc2021) hu21
  have hu19 : x19 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1920) hu20
  have hu18 : x18 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1819) hu19
  have hu17 : x17 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1718) hu18
  have hu16 : x16 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1617) hu17
  have hu15 : x15 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1516) hu16
  have hu14 : x14 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1415) hu15
  have hu13 : x13 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1314) hu14
  have hu12 : x12 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1213) hu13
  have hu11 : x11 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1112) hu12
  have hu10 : x10 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc1011) hu11
  have hu9 : x9 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc910) hu10
  have hu8 : x8 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc89) hu9
  have hu7 : x7 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc78) hu8
  have hu6 : x6 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc67) hu7
  have hu5 : x5 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc56) hu6
  have hu4 : x4 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc45) hu5
  have hu3 : x3 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc34) hu4
  have hu2 : x2 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc23) hu3
  have hu1 : x1 ≤ ((1350) : ℝ) := le_trans (le_of_lt hc12) hu2
  ...
  have hTbox : ∀ z ∈ T, ((((1 / 2000000)) : ℝ) ≤ z.re ∧ z.re ≤ ((1999999 / 2000000))) ∧ (((1300) : ℝ) ≤ z.im ∧ z.im ≤ (1350)) := by
    rw [hTdef]
    refine RHInBox.line_toFinset_forall xsL ?_
    rw [hxsdef]
    simp only [List.forall_mem_cons]
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (1300) (1350) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((1300) : ℝ) (1350)) := hE0holo
  ...
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((1350) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1300)) ((1350))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1300)) ((1350))) := by
  ...
  exact RHInBox.rh_in_box_of_certificate (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (1300) (1350) cPB RPB 43
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d2000000_1999999d2000000_1300_1350
