/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 1000000),(999999 / 1000000)] x [100,200]` with `N = 50` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (150)*I`, radius `R = Real.sqrt ((25000499999000001 / 2000000000000))`,
...
namespace RHInBox_1d1000000_999999d1000000_100_200

/-- Chosen Blaschke ball center for the box `[(1 / 1000000),(999999 / 1000000)] x [100,200]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (150)⟩

/-- Chosen Blaschke ball radius (squared radius `(25000499999000001 / 2000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((25000499999000001 / 2000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 1000000),(999999 / 1000000)] x [100,200]` with `N = 50`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (150)*I`, `R = Real.sqrt ((25000499999000001 / 2000000000000))`, and count `N = 50`.  Takes the
    documented Arb inputs `hLine` (the 50 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*50`).  conjecture1_proved = False. -/
theorem rh_in_box_1d1000000_999999d1000000_100_200
    (hLine : ∃ x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21 x22 x23 x24 x25 x26 x27 x28 x29 x30 x31 x32 x33 x34 x35 x36 x37 x38 x39 x40 x41 x42 x43 x44 x45 x46 x47 x48 x49 x50 : ℝ,
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      ...
      ((∫ x in (((1 / 1000000)) : ℝ)..((999999 / 1000000)), logDeriv riemannZeta (↑x + (((100) : ℝ) : ℂ) * I))
        ...
        = 2 * π * I * (50 : ℂ))) :
    (∀ ρ, ((((1 / 1000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((999999 / 1000000))) → (((100) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (200)) →
      riemannZeta ρ = 0 → ρ.re = 1 / 2) := by
  have hRpos : (0 : ℝ) < RPB := RPB_pos
  have hsig : (((1 / 1000000)) : ℝ) ≤ ((999999 / 1000000)) := by norm_num
  have hTle : ((100) : ℝ) ≤ (200) := by norm_num
  have hbox_ball : ∀ ρ : ℂ, ((((1 / 1000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((999999 / 1000000))) →
      (((100) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (200)) → ρ ∈ Metric.ball cPB RPB := by
    intro ρ hre him
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    apply Real.sqrt_lt_sqrt (by positivity)
    have h1 := hre.1; have h2 := hre.2; have h3 := him.1; have h4 := him.2
    nlinarith [h1, h2, h3, h4, sq_nonneg (ρ.re - ((1 / 2))), sq_nonneg (ρ.im - (150))]
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    intro hlt
    simp only [Complex.one_re, Complex.one_im] at hlt
    have hle : Real.sqrt ((25000499999000001 / 2000000000000)) ≤
        Real.sqrt (((1 : ℝ) - ((1 / 2))) ^ 2 + ((0 : ℝ) - (150)) ^ 2) :=
      Real.sqrt_le_sqrt (by norm_num)
    linarith [hlt, hle]
  obtain ⟨x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39, x40, x41, x42, x43, x44, x45, x46, x47, x48, x49, x50, ⟨hlo, hc12, hc23, hc34, hc45, hc56, hc67, hc78, hc89, hc910, hc1011, hc1112, hc1213, hc1314, hc1415, hc1516, hc1617, hc1718, hc1819, hc1920, hc2021, hc2122, hc2223, hc2324, hc2425, hc2526, hc2627, hc2728, hc2829, hc2930, hc3031, hc3132, hc3233, hc3334, hc3435, hc3536, hc3637, hc3738, hc3839, hc3940, hc4041, hc4142, hc4243, hc4344, hc4445, hc4546, hc4647, hc4748, hc4849, hc4950, hhi⟩, hΛ1, hΛ2, hΛ3, hΛ4, hΛ5, hΛ6, hΛ7, hΛ8, hΛ9, hΛ10, hΛ11, hΛ12, hΛ13, hΛ14, hΛ15, hΛ16, hΛ17, hΛ18, hΛ19, hΛ20, hΛ21, hΛ22, hΛ23, hΛ24, hΛ25, hΛ26, hΛ27, hΛ28, hΛ29, hΛ30, hΛ31, hΛ32, hΛ33, hΛ34, hΛ35, hΛ36, hΛ37, hΛ38, hΛ39, hΛ40, hΛ41, hΛ42, hΛ43, hΛ44, hΛ45, hΛ46, hΛ47, hΛ48, hΛ49, hΛ50⟩ := hLine
  ...
  set xsL : List ℝ := [x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39, x40, x41, x42, x43, x44, x45, x46, x47, x48, x49, x50] with hxsdef
  have hchain : xsL.IsChain (· < ·) := by
    rw [hxsdef]
    simp only [List.isChain_cons_cons]
    exact ⟨hc12, hc23, hc34, hc45, hc56, hc67, hc78, hc89, hc910, hc1011, hc1112, hc1213, hc1314, hc1415, hc1516, hc1617, hc1718, hc1819, hc1920, hc2021, hc2122, hc2223, hc2324, hc2425, hc2526, hc2627, hc2728, hc2829, hc2930, hc3031, hc3132, hc3233, hc3334, hc3435, hc3536, hc3637, hc3738, hc3839, hc3940, hc4041, hc4142, hc4243, hc4344, hc4445, hc4546, hc4647, hc4748, hc4849, hc4950, List.IsChain.singleton _⟩
  set T : Finset ℂ :=
    (xsL.map fun t : ℝ => (1 / 2 : ℂ) + (t : ℂ) * Complex.I).toFinset with hTdef
  have hTcard : T.card = 50 := by
  ...
  have hb24 : ((100) : ℝ) ≤ x24 := le_trans hb23 (le_of_lt hc2324)
  have hb25 : ((100) : ℝ) ≤ x25 := le_trans hb24 (le_of_lt hc2425)
  have hb26 : ((100) : ℝ) ≤ x26 := le_trans hb25 (le_of_lt hc2526)
  have hb27 : ((100) : ℝ) ≤ x27 := le_trans hb26 (le_of_lt hc2627)
  have hb28 : ((100) : ℝ) ≤ x28 := le_trans hb27 (le_of_lt hc2728)
  have hb29 : ((100) : ℝ) ≤ x29 := le_trans hb28 (le_of_lt hc2829)
  have hb30 : ((100) : ℝ) ≤ x30 := le_trans hb29 (le_of_lt hc2930)
  have hb31 : ((100) : ℝ) ≤ x31 := le_trans hb30 (le_of_lt hc3031)
  have hb32 : ((100) : ℝ) ≤ x32 := le_trans hb31 (le_of_lt hc3132)
  have hb33 : ((100) : ℝ) ≤ x33 := le_trans hb32 (le_of_lt hc3233)
  have hb34 : ((100) : ℝ) ≤ x34 := le_trans hb33 (le_of_lt hc3334)
  have hb35 : ((100) : ℝ) ≤ x35 := le_trans hb34 (le_of_lt hc3435)
  have hb36 : ((100) : ℝ) ≤ x36 := le_trans hb35 (le_of_lt hc3536)
  have hb37 : ((100) : ℝ) ≤ x37 := le_trans hb36 (le_of_lt hc3637)
  have hb38 : ((100) : ℝ) ≤ x38 := le_trans hb37 (le_of_lt hc3738)
  have hb39 : ((100) : ℝ) ≤ x39 := le_trans hb38 (le_of_lt hc3839)
  have hb40 : ((100) : ℝ) ≤ x40 := le_trans hb39 (le_of_lt hc3940)
  have hb41 : ((100) : ℝ) ≤ x41 := le_trans hb40 (le_of_lt hc4041)
  have hb42 : ((100) : ℝ) ≤ x42 := le_trans hb41 (le_of_lt hc4142)
  have hb43 : ((100) : ℝ) ≤ x43 := le_trans hb42 (le_of_lt hc4243)
  have hb44 : ((100) : ℝ) ≤ x44 := le_trans hb43 (le_of_lt hc4344)
  have hb45 : ((100) : ℝ) ≤ x45 := le_trans hb44 (le_of_lt hc4445)
  have hb46 : ((100) : ℝ) ≤ x46 := le_trans hb45 (le_of_lt hc4546)
  have hb47 : ((100) : ℝ) ≤ x47 := le_trans hb46 (le_of_lt hc4647)
  have hb48 : ((100) : ℝ) ≤ x48 := le_trans hb47 (le_of_lt hc4748)
  have hb49 : ((100) : ℝ) ≤ x49 := le_trans hb48 (le_of_lt hc4849)
  have hb50 : ((100) : ℝ) ≤ x50 := le_trans hb49 (le_of_lt hc4950)
  have hu50 : x50 ≤ ((200) : ℝ) := hhi
  have hu49 : x49 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4950) hu50
  have hu48 : x48 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4849) hu49
  have hu47 : x47 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4748) hu48
  have hu46 : x46 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4647) hu47
  have hu45 : x45 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4546) hu46
  have hu44 : x44 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4445) hu45
  have hu43 : x43 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4344) hu44
  have hu42 : x42 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4243) hu43
  have hu41 : x41 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4142) hu42
  have hu40 : x40 ≤ ((200) : ℝ) := le_trans (le_of_lt hc4041) hu41
  have hu39 : x39 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3940) hu40
  have hu38 : x38 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3839) hu39
  have hu37 : x37 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3738) hu38
  have hu36 : x36 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3637) hu37
  have hu35 : x35 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3536) hu36
  have hu34 : x34 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3435) hu35
  have hu33 : x33 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3334) hu34
  have hu32 : x32 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3233) hu33
  have hu31 : x31 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3132) hu32
  have hu30 : x30 ≤ ((200) : ℝ) := le_trans (le_of_lt hc3031) hu31
  have hu29 : x29 ≤ ((200) : ℝ) := le_trans (le_of_lt hc2930) hu30
  have hu28 : x28 ≤ ((200) : ℝ) := le_trans (le_of_lt hc2829) hu29
  have hu27 : x27 ≤ ((200) : ℝ) := le_trans (le_of_lt hc2728) hu28
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 1000000)) : ℝ) ((999999 / 1000000)) (100) (200) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 1000000)) : ℝ) ((999999 / 1000000)) ×ℂ Set.Icc ((100) : ℝ) (200)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 1000000)) : ℝ)..((999999 / 1000000)), logDeriv riemannZeta (↑x + (((100) : ℝ) : ℂ) * I))
        - (∫ x in (((1 / 1000000)) : ℝ)..((999999 / 1000000)), logDeriv riemannZeta (↑x + (((200) : ℝ) : ℂ) * I))
        + I • (∫ y in ((100) : ℝ)..(200), logDeriv riemannZeta (((((999999 / 1000000)) : ℝ) : ℂ) + ↑y * I))
        - I • (∫ y in ((100) : ℝ)..(200), logDeriv riemannZeta (((((1 / 1000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((50 : ℤ) : ℂ) := by
    rw [show (((50 : ℤ) : ℂ)) = (50 : ℂ) by norm_num]; exact hwindA
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((200) : ℝ) : ℂ) * I)) volume (((1 / 1000000))) (((999999 / 1000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((999999 / 1000000)) : ℝ) : ℂ) + ↑y * I)) volume ((100)) ((200))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 1000000)) : ℝ) : ℂ) + ↑y * I)) volume ((100)) ((200))) := by
  ...
  have hcountN : (50 : ℤ) = (T.card : ℤ) := by rw [hTcard]; norm_num
  exact RHInBox.rh_in_box_of_certificate (((1 / 1000000)) : ℝ) ((999999 / 1000000)) (100) (200) cPB RPB 50
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d1000000_999999d1000000_100_200
