...
/-- The 25-band partition of `[2000, 3000]`. -/
...
theorem segment_2000_3000
  ...
  have hre' : ((1 / 4000000) : ℝ) ≤ ρ.re ∧ ρ.re ≤ 3999999 / 4000000 := by
    ...
    linarith [h2, hre_eq]
  interval_cases i
  · exact hseg0 ρ hre' ⟨le_trans (show ((2000) : ℝ) ≤ (2000) by norm_num) him.1, le_trans him.2 (show ((2040) : ℝ) ≤ (2040) by norm_num)⟩ hz
  · exact hseg1 ρ hre' ⟨le_trans (show ((2040) : ℝ) ≤ (2040) by norm_num) him.1, le_trans him.2 (show ((2080) : ℝ) ≤ (2080) by norm_num)⟩ hz
  · exact hseg2 ρ hre' ⟨le_trans (show ((2080) : ℝ) ≤ (2080) by norm_num) him.1, le_trans him.2 (show ((2120) : ℝ) ≤ (2120) by norm_num)⟩ hz
  · exact hseg3 ρ hre' ⟨le_trans (show ((2120) : ℝ) ≤ (2120) by norm_num) him.1, le_trans him.2 (show ((2160) : ℝ) ≤ (2160) by norm_num)⟩ hz
  · exact hseg4 ρ hre' ⟨le_trans (show ((2160) : ℝ) ≤ (2160) by norm_num) him.1, le_trans him.2 (show ((2200) : ℝ) ≤ (2200) by norm_num)⟩ hz
  · exact hseg5 ρ hre' ⟨le_trans (show ((2200) : ℝ) ≤ (2200) by norm_num) him.1, le_trans him.2 (show ((2240) : ℝ) ≤ (8961 / 4) by norm_num)⟩ hz
  · exact hseg6 ρ hre' ⟨le_trans (show ((2240) : ℝ) ≤ (2240) by norm_num) him.1, le_trans him.2 (show ((2280) : ℝ) ≤ (2280) by norm_num)⟩ hz
  · exact hseg7 ρ hre' ⟨le_trans (show ((2280) : ℝ) ≤ (2280) by norm_num) him.1, le_trans him.2 (show ((2320) : ℝ) ≤ (2320) by norm_num)⟩ hz
  · exact hseg8 ρ hre' ⟨le_trans (show ((2320) : ℝ) ≤ (2320) by norm_num) him.1, le_trans him.2 (show ((2360) : ℝ) ≤ (2360) by norm_num)⟩ hz
  · exact hseg9 ρ hre' ⟨le_trans (show ((2360) : ℝ) ≤ (2360) by norm_num) him.1, le_trans him.2 (show ((2400) : ℝ) ≤ (2400) by norm_num)⟩ hz
  · exact hseg10 ρ hre' ⟨le_trans (show ((2400) : ℝ) ≤ (2400) by norm_num) him.1, le_trans him.2 (show ((2440) : ℝ) ≤ (2440) by norm_num)⟩ hz
  · exact hseg11 ρ hre' ⟨le_trans (show ((9759 / 4) : ℝ) ≤ (2440) by norm_num) him.1, le_trans him.2 (show ((2480) : ℝ) ≤ (2480) by norm_num)⟩ hz
  · exact hseg12 ρ hre' ⟨le_trans (show ((9919 / 4) : ℝ) ≤ (2480) by norm_num) him.1, le_trans him.2 (show ((2520) : ℝ) ≤ (2520) by norm_num)⟩ hz
  · exact hseg13 ρ hre' ⟨le_trans (show ((2520) : ℝ) ≤ (2520) by norm_num) him.1, le_trans him.2 (show ((2560) : ℝ) ≤ (2560) by norm_num)⟩ hz
  · exact hseg14 ρ hre' ⟨le_trans (show ((2560) : ℝ) ≤ (2560) by norm_num) him.1, le_trans him.2 (show ((2600) : ℝ) ≤ (2600) by norm_num)⟩ hz
  · exact hseg15 ρ hre' ⟨le_trans (show ((2600) : ℝ) ≤ (2600) by norm_num) him.1, le_trans him.2 (show ((2640) : ℝ) ≤ (10561 / 4) by norm_num)⟩ hz
  · exact hseg16 ρ hre' ⟨le_trans (show ((2640) : ℝ) ≤ (2640) by norm_num) him.1, le_trans him.2 (show ((2680) : ℝ) ≤ (10721 / 4) by norm_num)⟩ hz
  · exact hseg17 ρ hre' ⟨le_trans (show ((2680) : ℝ) ≤ (2680) by norm_num) him.1, le_trans him.2 (show ((2720) : ℝ) ≤ (2720) by norm_num)⟩ hz
  · exact hseg18 ρ hre' ⟨le_trans (show ((2720) : ℝ) ≤ (2720) by norm_num) him.1, le_trans him.2 (show ((2760) : ℝ) ≤ (2760) by norm_num)⟩ hz
  · exact hseg19 ρ hre' ⟨le_trans (show ((2760) : ℝ) ≤ (2760) by norm_num) him.1, le_trans him.2 (show ((2800) : ℝ) ≤ (11201 / 4) by norm_num)⟩ hz
  · exact hseg20 ρ hre' ⟨le_trans (show ((2800) : ℝ) ≤ (2800) by norm_num) him.1, le_trans him.2 (show ((2840) : ℝ) ≤ (2840) by norm_num)⟩ hz
  · exact hseg21 ρ hre' ⟨le_trans (show ((2840) : ℝ) ≤ (2840) by norm_num) him.1, le_trans him.2 (show ((2880) : ℝ) ≤ (2880) by norm_num)⟩ hz
  · exact hseg22 ρ hre' ⟨le_trans (show ((2880) : ℝ) ≤ (2880) by norm_num) him.1, le_trans him.2 (show ((2920) : ℝ) ≤ (2920) by norm_num)⟩ hz
  · exact hseg23 ρ hre' ⟨le_trans (show ((2920) : ℝ) ≤ (2920) by norm_num) him.1, le_trans him.2 (show ((2960) : ℝ) ≤ (11841 / 4) by norm_num)⟩ hz
  · exact hseg24 ρ hre' ⟨le_trans (show ((2960) : ℝ) ≤ (2960) by norm_num) him.1, le_trans him.2 (show ((3000) : ℝ) ≤ (3000) by norm_num)⟩ hz
