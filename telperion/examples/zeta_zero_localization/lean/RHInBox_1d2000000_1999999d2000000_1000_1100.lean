/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 2000000),(1999999 / 2000000)] x [1000,1100]` with `N = 81` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (1050)*I`, radius `R = Real.sqrt ((4420001999998000001 / 8000000000000))`,
...
namespace RHInBox_1d2000000_1999999d2000000_1000_1100

/-- Chosen Blaschke ball center for the box `[(1 / 2000000),(1999999 / 2000000)] x [1000,1100]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (1050)⟩

/-- Chosen Blaschke ball radius (squared radius `(4420001999998000001 / 8000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((4420001999998000001 / 8000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 2000000),(1999999 / 2000000)] x [1000,1100]` with `N = 81`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (1050)*I`, `R = Real.sqrt ((4420001999998000001 / 8000000000000))`, and count `N = 81`.  Takes the
    documented Arb inputs `hLine` (the 81 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*81`).  conjecture1_proved = False. -/
theorem rh_in_box_1d2000000_1999999d2000000_1000_1100
    (hLine : ∃ x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21 x22 x23 x24 x25 x26 x27 x28 x29 x30 x31 x32 x33 x34 x35 x36 x37 x38 x39 x40 x41 x42 x43 x44 x45 x46 x47 x48 x49 x50 x51 x52 x53 x54 x55 x56 x57 x58 x59 x60 x61 x62 x63 x64 x65 x66 x67 x68 x69 x70 x71 x72 x73 x74 x75 x76 x77 x78 x79 x80 x81 : ℝ,
      (1000 ≤ x1 ∧ x1 < x2 ∧ x2 < x3 ∧ x3 < x4 ∧ x4 < x5 ∧ x5 < x6 ∧ x6 < x7 ∧ x7 < x8 ∧ x8 < x9 ∧ x9 < x10 ∧ x10 < x11 ∧ x11 < x12 ∧ x12 < x13 ∧ x13 < x14 ∧ x14 < x15 ∧ x15 < x16 ∧ x16 < x17 ∧ x17 < x18 ∧ x18 < x19 ∧ x19 < x20 ∧ x20 < x21 ∧ x21 < x22 ∧ x22 < x23 ∧ x23 < x24 ∧ x24 < x25 ∧ x25 < x26 ∧ x26 < x27 ∧ x27 < x28 ∧ x28 < x29 ∧ x29 < x30 ∧ x30 < x31 ∧ x31 < x32 ∧ x32 < x33 ∧ x33 < x34 ∧ x34 < x35 ∧ x35 < x36 ∧ x36 < x37 ∧ x37 < x38 ∧ x38 < x39 ∧ x39 < x40 ∧ x40 < x41 ∧ x41 < x42 ∧ x42 < x43 ∧ x43 < x44 ∧ x44 < x45 ∧ x45 < x46 ∧ x46 < x47 ∧ x47 < x48 ∧ x48 < x49 ∧ x49 < x50 ∧ x50 < x51 ∧ x51 < x52 ∧ x52 < x53 ∧ x53 < x54 ∧ x54 < x55 ∧ x55 < x56 ∧ x56 < x57 ∧ x57 < x58 ∧ x58 < x59 ∧ x59 < x60 ∧ x60 < x61 ∧ x61 < x62 ∧ x62 < x63 ∧ x63 < x64 ∧ x64 < x65 ∧ x65 < x66 ∧ x66 < x67 ∧ x67 < x68 ∧ x68 < x69 ∧ x69 < x70 ∧ x70 < x71 ∧ x71 < x72 ∧ x72 < x73 ∧ x73 < x74 ∧ x74 < x75 ∧ x75 < x76 ∧ x76 < x77 ∧ x77 < x78 ∧ x78 < x79 ∧ x79 < x80 ∧ x80 < x81 ∧ x81 ≤ 1100) ∧
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      DifferentiableOn ℂ E (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((1000) : ℝ) (1100)) →
      ...
      (∀ y ∈ Set.uIcc ((1000) : ℝ) (1100), riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((1000) : ℝ) (1100), riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ ρ ∈ s, (((1 / 2000000)) : ℝ) < ρ.re ∧ ρ.re < ((1999999 / 2000000)) ∧ ((1000) : ℝ) < ρ.im ∧ ρ.im < (1100)) ∧
      ...
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1000)) ((1100))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1000)) ((1100))) ∧
      (IntervalIntegrable
      ...
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1000)) ((1100))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((1000)) ((1100))) ∧
      ...
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1000)) ((1100))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1000)) ((1100))) ∧
  ...
  set xsL : List ℝ := [x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39, x40, x41, x42, x43, x44, x45, x46, x47, x48, x49, x50, x51, x52, x53, x54, x55, x56, x57, x58, x59, x60, x61, x62, x63, x64, x65, x66, x67, x68, x69, x70, x71, x72, x73, x74, x75, x76, x77, x78, x79, x80, x81] with hxsdef
  have hchain : xsL.IsChain (· < ·) := by
    rw [hxsdef]
    simp only [List.isChain_cons_cons]
    exact ⟨hc12, hc23, hc34, hc45, hc56, hc67, hc78, hc89, hc910, hc1011, hc1112, hc1213, hc1314, hc1415, hc1516, hc1617, hc1718, hc1819, hc1920, hc2021, hc2122, hc2223, hc2324, hc2425, hc2526, hc2627, hc2728, hc2829, hc2930, hc3031, hc3132, hc3233, hc3334, hc3435, hc3536, hc3637, hc3738, hc3839, hc3940, hc4041, hc4142, hc4243, hc4344, hc4445, hc4546, hc4647, hc4748, hc4849, hc4950, hc5051, hc5152, hc5253, hc5354, hc5455, hc5556, hc5657, hc5758, hc5859, hc5960, hc6061, hc6162, hc6263, hc6364, hc6465, hc6566, hc6667, hc6768, hc6869, hc6970, hc7071, hc7172, hc7273, hc7374, hc7475, hc7576, hc7677, hc7778, hc7879, hc7980, hc8081, List.IsChain.singleton _⟩
  set T : Finset ℂ :=
    (xsL.map fun t : ℝ => (1 / 2 : ℂ) + (t : ℂ) * Complex.I).toFinset with hTdef
  have hTcard : T.card = 81 := by
    rw [hTdef, RHInBox.line_toFinset_card xsL hchain, hxsdef]
    rfl
  have hb1 : ((1000) : ℝ) ≤ x1 := hlo
  have hb2 : ((1000) : ℝ) ≤ x2 := le_trans hb1 (le_of_lt hc12)
  have hb3 : ((1000) : ℝ) ≤ x3 := le_trans hb2 (le_of_lt hc23)
  have hb4 : ((1000) : ℝ) ≤ x4 := le_trans hb3 (le_of_lt hc34)
  have hb5 : ((1000) : ℝ) ≤ x5 := le_trans hb4 (le_of_lt hc45)
  have hb6 : ((1000) : ℝ) ≤ x6 := le_trans hb5 (le_of_lt hc56)
  have hb7 : ((1000) : ℝ) ≤ x7 := le_trans hb6 (le_of_lt hc67)
  have hb8 : ((1000) : ℝ) ≤ x8 := le_trans hb7 (le_of_lt hc78)
  have hb9 : ((1000) : ℝ) ≤ x9 := le_trans hb8 (le_of_lt hc89)
  have hb10 : ((1000) : ℝ) ≤ x10 := le_trans hb9 (le_of_lt hc910)
  have hb11 : ((1000) : ℝ) ≤ x11 := le_trans hb10 (le_of_lt hc1011)
  have hb12 : ((1000) : ℝ) ≤ x12 := le_trans hb11 (le_of_lt hc1112)
  have hb13 : ((1000) : ℝ) ≤ x13 := le_trans hb12 (le_of_lt hc1213)
  have hb14 : ((1000) : ℝ) ≤ x14 := le_trans hb13 (le_of_lt hc1314)
  have hb15 : ((1000) : ℝ) ≤ x15 := le_trans hb14 (le_of_lt hc1415)
  have hb16 : ((1000) : ℝ) ≤ x16 := le_trans hb15 (le_of_lt hc1516)
  have hb17 : ((1000) : ℝ) ≤ x17 := le_trans hb16 (le_of_lt hc1617)
  have hb18 : ((1000) : ℝ) ≤ x18 := le_trans hb17 (le_of_lt hc1718)
  have hb19 : ((1000) : ℝ) ≤ x19 := le_trans hb18 (le_of_lt hc1819)
  have hb20 : ((1000) : ℝ) ≤ x20 := le_trans hb19 (le_of_lt hc1920)
  have hb21 : ((1000) : ℝ) ≤ x21 := le_trans hb20 (le_of_lt hc2021)
  have hb22 : ((1000) : ℝ) ≤ x22 := le_trans hb21 (le_of_lt hc2122)
  have hb23 : ((1000) : ℝ) ≤ x23 := le_trans hb22 (le_of_lt hc2223)
  have hb24 : ((1000) : ℝ) ≤ x24 := le_trans hb23 (le_of_lt hc2324)
  have hb25 : ((1000) : ℝ) ≤ x25 := le_trans hb24 (le_of_lt hc2425)
  have hb26 : ((1000) : ℝ) ≤ x26 := le_trans hb25 (le_of_lt hc2526)
  have hb27 : ((1000) : ℝ) ≤ x27 := le_trans hb26 (le_of_lt hc2627)
  have hb28 : ((1000) : ℝ) ≤ x28 := le_trans hb27 (le_of_lt hc2728)
  have hb29 : ((1000) : ℝ) ≤ x29 := le_trans hb28 (le_of_lt hc2829)
  have hb30 : ((1000) : ℝ) ≤ x30 := le_trans hb29 (le_of_lt hc2930)
  have hb31 : ((1000) : ℝ) ≤ x31 := le_trans hb30 (le_of_lt hc3031)
  have hb32 : ((1000) : ℝ) ≤ x32 := le_trans hb31 (le_of_lt hc3132)
  have hb33 : ((1000) : ℝ) ≤ x33 := le_trans hb32 (le_of_lt hc3233)
  have hb34 : ((1000) : ℝ) ≤ x34 := le_trans hb33 (le_of_lt hc3334)
  have hb35 : ((1000) : ℝ) ≤ x35 := le_trans hb34 (le_of_lt hc3435)
  have hb36 : ((1000) : ℝ) ≤ x36 := le_trans hb35 (le_of_lt hc3536)
  have hb37 : ((1000) : ℝ) ≤ x37 := le_trans hb36 (le_of_lt hc3637)
  have hb38 : ((1000) : ℝ) ≤ x38 := le_trans hb37 (le_of_lt hc3738)
  have hb39 : ((1000) : ℝ) ≤ x39 := le_trans hb38 (le_of_lt hc3839)
  have hb40 : ((1000) : ℝ) ≤ x40 := le_trans hb39 (le_of_lt hc3940)
  have hb41 : ((1000) : ℝ) ≤ x41 := le_trans hb40 (le_of_lt hc4041)
  have hb42 : ((1000) : ℝ) ≤ x42 := le_trans hb41 (le_of_lt hc4142)
  have hb43 : ((1000) : ℝ) ≤ x43 := le_trans hb42 (le_of_lt hc4243)
  have hb44 : ((1000) : ℝ) ≤ x44 := le_trans hb43 (le_of_lt hc4344)
  have hb45 : ((1000) : ℝ) ≤ x45 := le_trans hb44 (le_of_lt hc4445)
  have hb46 : ((1000) : ℝ) ≤ x46 := le_trans hb45 (le_of_lt hc4546)
  have hb47 : ((1000) : ℝ) ≤ x47 := le_trans hb46 (le_of_lt hc4647)
  have hb48 : ((1000) : ℝ) ≤ x48 := le_trans hb47 (le_of_lt hc4748)
  have hb49 : ((1000) : ℝ) ≤ x49 := le_trans hb48 (le_of_lt hc4849)
  have hb50 : ((1000) : ℝ) ≤ x50 := le_trans hb49 (le_of_lt hc4950)
  have hb51 : ((1000) : ℝ) ≤ x51 := le_trans hb50 (le_of_lt hc5051)
  have hb52 : ((1000) : ℝ) ≤ x52 := le_trans hb51 (le_of_lt hc5152)
  have hb53 : ((1000) : ℝ) ≤ x53 := le_trans hb52 (le_of_lt hc5253)
  have hb54 : ((1000) : ℝ) ≤ x54 := le_trans hb53 (le_of_lt hc5354)
  have hb55 : ((1000) : ℝ) ≤ x55 := le_trans hb54 (le_of_lt hc5455)
  have hb56 : ((1000) : ℝ) ≤ x56 := le_trans hb55 (le_of_lt hc5556)
  have hb57 : ((1000) : ℝ) ≤ x57 := le_trans hb56 (le_of_lt hc5657)
  have hb58 : ((1000) : ℝ) ≤ x58 := le_trans hb57 (le_of_lt hc5758)
  have hb59 : ((1000) : ℝ) ≤ x59 := le_trans hb58 (le_of_lt hc5859)
  have hb60 : ((1000) : ℝ) ≤ x60 := le_trans hb59 (le_of_lt hc5960)
  have hb61 : ((1000) : ℝ) ≤ x61 := le_trans hb60 (le_of_lt hc6061)
  have hb62 : ((1000) : ℝ) ≤ x62 := le_trans hb61 (le_of_lt hc6162)
  have hb63 : ((1000) : ℝ) ≤ x63 := le_trans hb62 (le_of_lt hc6263)
  have hb64 : ((1000) : ℝ) ≤ x64 := le_trans hb63 (le_of_lt hc6364)
  have hb65 : ((1000) : ℝ) ≤ x65 := le_trans hb64 (le_of_lt hc6465)
  have hb66 : ((1000) : ℝ) ≤ x66 := le_trans hb65 (le_of_lt hc6566)
  have hb67 : ((1000) : ℝ) ≤ x67 := le_trans hb66 (le_of_lt hc6667)
  have hb68 : ((1000) : ℝ) ≤ x68 := le_trans hb67 (le_of_lt hc6768)
  have hb69 : ((1000) : ℝ) ≤ x69 := le_trans hb68 (le_of_lt hc6869)
  have hb70 : ((1000) : ℝ) ≤ x70 := le_trans hb69 (le_of_lt hc6970)
  have hb71 : ((1000) : ℝ) ≤ x71 := le_trans hb70 (le_of_lt hc7071)
  have hb72 : ((1000) : ℝ) ≤ x72 := le_trans hb71 (le_of_lt hc7172)
  have hb73 : ((1000) : ℝ) ≤ x73 := le_trans hb72 (le_of_lt hc7273)
  have hb74 : ((1000) : ℝ) ≤ x74 := le_trans hb73 (le_of_lt hc7374)
  have hb75 : ((1000) : ℝ) ≤ x75 := le_trans hb74 (le_of_lt hc7475)
  have hb76 : ((1000) : ℝ) ≤ x76 := le_trans hb75 (le_of_lt hc7576)
  have hb77 : ((1000) : ℝ) ≤ x77 := le_trans hb76 (le_of_lt hc7677)
  have hb78 : ((1000) : ℝ) ≤ x78 := le_trans hb77 (le_of_lt hc7778)
  have hb79 : ((1000) : ℝ) ≤ x79 := le_trans hb78 (le_of_lt hc7879)
  have hb80 : ((1000) : ℝ) ≤ x80 := le_trans hb79 (le_of_lt hc7980)
  have hb81 : ((1000) : ℝ) ≤ x81 := le_trans hb80 (le_of_lt hc8081)
  have hu81 : x81 ≤ ((1100) : ℝ) := hhi
  have hu80 : x80 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc8081) hu81
  have hu79 : x79 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7980) hu80
  have hu78 : x78 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7879) hu79
  have hu77 : x77 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7778) hu78
  have hu76 : x76 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7677) hu77
  have hu75 : x75 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7576) hu76
  have hu74 : x74 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7475) hu75
  have hu73 : x73 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7374) hu74
  have hu72 : x72 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7273) hu73
  have hu71 : x71 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7172) hu72
  have hu70 : x70 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc7071) hu71
  have hu69 : x69 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6970) hu70
  have hu68 : x68 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6869) hu69
  have hu67 : x67 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6768) hu68
  have hu66 : x66 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6667) hu67
  have hu65 : x65 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6566) hu66
  have hu64 : x64 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6465) hu65
  have hu63 : x63 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6364) hu64
  have hu62 : x62 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6263) hu63
  have hu61 : x61 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6162) hu62
  have hu60 : x60 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc6061) hu61
  have hu59 : x59 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5960) hu60
  have hu58 : x58 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5859) hu59
  have hu57 : x57 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5758) hu58
  have hu56 : x56 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5657) hu57
  have hu55 : x55 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5556) hu56
  have hu54 : x54 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5455) hu55
  have hu53 : x53 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5354) hu54
  have hu52 : x52 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5253) hu53
  have hu51 : x51 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5152) hu52
  have hu50 : x50 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc5051) hu51
  have hu49 : x49 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4950) hu50
  have hu48 : x48 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4849) hu49
  have hu47 : x47 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4748) hu48
  have hu46 : x46 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4647) hu47
  have hu45 : x45 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4546) hu46
  have hu44 : x44 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4445) hu45
  have hu43 : x43 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4344) hu44
  have hu42 : x42 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4243) hu43
  have hu41 : x41 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4142) hu42
  have hu40 : x40 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc4041) hu41
  have hu39 : x39 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3940) hu40
  have hu38 : x38 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3839) hu39
  have hu37 : x37 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3738) hu38
  have hu36 : x36 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3637) hu37
  have hu35 : x35 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3536) hu36
  have hu34 : x34 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3435) hu35
  have hu33 : x33 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3334) hu34
  have hu32 : x32 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3233) hu33
  have hu31 : x31 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3132) hu32
  have hu30 : x30 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc3031) hu31
  have hu29 : x29 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2930) hu30
  have hu28 : x28 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2829) hu29
  have hu27 : x27 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2728) hu28
  have hu26 : x26 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2627) hu27
  have hu25 : x25 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2526) hu26
  have hu24 : x24 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2425) hu25
  have hu23 : x23 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2324) hu24
  have hu22 : x22 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2223) hu23
  have hu21 : x21 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2122) hu22
  have hu20 : x20 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc2021) hu21
  have hu19 : x19 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1920) hu20
  have hu18 : x18 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1819) hu19
  have hu17 : x17 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1718) hu18
  have hu16 : x16 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1617) hu17
  have hu15 : x15 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1516) hu16
  have hu14 : x14 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1415) hu15
  have hu13 : x13 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1314) hu14
  have hu12 : x12 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1213) hu13
  have hu11 : x11 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1112) hu12
  have hu10 : x10 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc1011) hu11
  have hu9 : x9 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc910) hu10
  have hu8 : x8 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc89) hu9
  have hu7 : x7 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc78) hu8
  have hu6 : x6 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc67) hu7
  have hu5 : x5 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc56) hu6
  have hu4 : x4 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc45) hu5
  have hu3 : x3 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc34) hu4
  have hu2 : x2 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc23) hu3
  have hu1 : x1 ≤ ((1100) : ℝ) := le_trans (le_of_lt hc12) hu2
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (1000) (1100) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((1000) : ℝ) (1100)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((1000) : ℝ) : ℂ) * I))
        - (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((1100) : ℝ) : ℂ) * I))
        + I • (∫ y in ((1000) : ℝ)..(1100), logDeriv riemannZeta (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I))
        - I • (∫ y in ((1000) : ℝ)..(1100), logDeriv riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((81 : ℤ) : ℂ) := by
    rw [show (((81 : ℤ) : ℂ)) = (81 : ℂ) by norm_num]; exact hwindA
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((1100) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1000)) ((1100))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((1000)) ((1100))) := by
  ...
  have hcountN : (81 : ℤ) = (T.card : ℤ) := by rw [hTcard]; norm_num
  exact RHInBox.rh_in_box_of_certificate (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (1000) (1100) cPB RPB 81
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d2000000_1999999d2000000_1000_1100
