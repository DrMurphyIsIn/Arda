...
theorem segment_5000_6000
  ...
  have hre' : ((1 / 4000000) : ℝ) ≤ ρ.re ∧ ρ.re ≤ 3999999 / 4000000 := by
    ...
    linarith [h2, hre_eq]
  interval_cases i
  · exact hseg0 ρ hre' ⟨le_trans (show ((5000) : ℝ) ≤ (5000) by norm_num) him.1, le_trans him.2 (show ((5040) : ℝ) ≤ (5040) by norm_num)⟩ hz
  · exact hseg1 ρ hre' ⟨le_trans (show ((5040) : ℝ) ≤ (5040) by norm_num) him.1, le_trans him.2 (show ((5080) : ℝ) ≤ (5080) by norm_num)⟩ hz
  · exact hseg2 ρ hre' ⟨le_trans (show ((5080) : ℝ) ≤ (5080) by norm_num) him.1, le_trans him.2 (show ((5120) : ℝ) ≤ (5120) by norm_num)⟩ hz
  · exact hseg3 ρ hre' ⟨le_trans (show ((5120) : ℝ) ≤ (5120) by norm_num) him.1, le_trans him.2 (show ((5160) : ℝ) ≤ (20641 / 4) by norm_num)⟩ hz
  · exact hseg4 ρ hre' ⟨le_trans (show ((5160) : ℝ) ≤ (5160) by norm_num) him.1, le_trans him.2 (show ((5200) : ℝ) ≤ (5200) by norm_num)⟩ hz
  · exact hseg5 ρ hre' ⟨le_trans (show ((5200) : ℝ) ≤ (5200) by norm_num) him.1, le_trans him.2 (show ((5240) : ℝ) ≤ (5240) by norm_num)⟩ hz
  · exact hseg6 ρ hre' ⟨le_trans (show ((5240) : ℝ) ≤ (5240) by norm_num) him.1, le_trans him.2 (show ((5280) : ℝ) ≤ (5280) by norm_num)⟩ hz
  · exact hseg7 ρ hre' ⟨le_trans (show ((5280) : ℝ) ≤ (5280) by norm_num) him.1, le_trans him.2 (show ((5320) : ℝ) ≤ (5320) by norm_num)⟩ hz
  · exact hseg8 ρ hre' ⟨le_trans (show ((5320) : ℝ) ≤ (5320) by norm_num) him.1, le_trans him.2 (show ((5360) : ℝ) ≤ (5360) by norm_num)⟩ hz
  · exact hseg9 ρ hre' ⟨le_trans (show ((5360) : ℝ) ≤ (5360) by norm_num) him.1, le_trans him.2 (show ((5400) : ℝ) ≤ (5400) by norm_num)⟩ hz
  · exact hseg10 ρ hre' ⟨le_trans (show ((5400) : ℝ) ≤ (5400) by norm_num) him.1, le_trans him.2 (show ((5440) : ℝ) ≤ (5440) by norm_num)⟩ hz
  · exact hseg11 ρ hre' ⟨le_trans (show ((5440) : ℝ) ≤ (5440) by norm_num) him.1, le_trans him.2 (show ((5480) : ℝ) ≤ (5480) by norm_num)⟩ hz
  · exact hseg12 ρ hre' ⟨le_trans (show ((5480) : ℝ) ≤ (5480) by norm_num) him.1, le_trans him.2 (show ((5520) : ℝ) ≤ (5520) by norm_num)⟩ hz
  · exact hseg13 ρ hre' ⟨le_trans (show ((5520) : ℝ) ≤ (5520) by norm_num) him.1, le_trans him.2 (show ((5560) : ℝ) ≤ (5560) by norm_num)⟩ hz
  · exact hseg14 ρ hre' ⟨le_trans (show ((5560) : ℝ) ≤ (5560) by norm_num) him.1, le_trans him.2 (show ((5600) : ℝ) ≤ (5600) by norm_num)⟩ hz
  · exact hseg15 ρ hre' ⟨le_trans (show ((5600) : ℝ) ≤ (5600) by norm_num) him.1, le_trans him.2 (show ((5640) : ℝ) ≤ (5640) by norm_num)⟩ hz
  · exact hseg16 ρ hre' ⟨le_trans (show ((5640) : ℝ) ≤ (5640) by norm_num) him.1, le_trans him.2 (show ((5680) : ℝ) ≤ (5680) by norm_num)⟩ hz
  · exact hseg17 ρ hre' ⟨le_trans (show ((5680) : ℝ) ≤ (5680) by norm_num) him.1, le_trans him.2 (show ((5720) : ℝ) ≤ (5720) by norm_num)⟩ hz
  · exact hseg18 ρ hre' ⟨le_trans (show ((5720) : ℝ) ≤ (5720) by norm_num) him.1, le_trans him.2 (show ((5760) : ℝ) ≤ (5760) by norm_num)⟩ hz
  · exact hseg19 ρ hre' ⟨le_trans (show ((5760) : ℝ) ≤ (5760) by norm_num) him.1, le_trans him.2 (show ((5800) : ℝ) ≤ (23201 / 4) by norm_num)⟩ hz
  · exact hseg20 ρ hre' ⟨le_trans (show ((5800) : ℝ) ≤ (5800) by norm_num) him.1, le_trans him.2 (show ((5840) : ℝ) ≤ (5840) by norm_num)⟩ hz
  · exact hseg21 ρ hre' ⟨le_trans (show ((5840) : ℝ) ≤ (5840) by norm_num) him.1, le_trans him.2 (show ((5880) : ℝ) ≤ (5880) by norm_num)⟩ hz
  · exact hseg22 ρ hre' ⟨le_trans (show ((5880) : ℝ) ≤ (5880) by norm_num) him.1, le_trans him.2 (show ((5920) : ℝ) ≤ (23681 / 4) by norm_num)⟩ hz
  · exact hseg23 ρ hre' ⟨le_trans (show ((5920) : ℝ) ≤ (5920) by norm_num) him.1, le_trans him.2 (show ((5960) : ℝ) ≤ (5960) by norm_num)⟩ hz
  · exact hseg24 ρ hre' ⟨le_trans (show ((5960) : ℝ) ≤ (5960) by norm_num) him.1, le_trans him.2 (show ((6000) : ℝ) ≤ (6000) by norm_num)⟩ hz
