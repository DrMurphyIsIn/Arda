/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 4000000),(3999999 / 4000000)] x [23781,23812]` with `N = 42` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + ((47593 / 2))*I`, radius `R = Real.sqrt ((9060378447999996000001 / 32000000000000))`,
...
namespace RHInBox_1d4000000_3999999d4000000_23781_23812

/-- Chosen Blaschke ball center for the box `[(1 / 4000000),(3999999 / 4000000)] x [23781,23812]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), ((47593 / 2))⟩

/-- Chosen Blaschke ball radius (squared radius `(9060378447999996000001 / 32000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((9060378447999996000001 / 32000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 4000000),(3999999 / 4000000)] x [23781,23812]` with `N = 42`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + ((47593 / 2))*I`, `R = Real.sqrt ((9060378447999996000001 / 32000000000000))`, and count `N = 42`.  Takes the
...
theorem rh_in_box_1d4000000_3999999d4000000_23781_23812
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      DifferentiableOn ℂ E (Set.Icc (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) ×ℂ Set.Icc ((23781) : ℝ) (23812)) →
      ...
      (∀ y ∈ Set.uIcc ((23781) : ℝ) (23812), riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((23781) : ℝ) (23812), riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ ρ ∈ s, (((1 / 4000000)) : ℝ) < ρ.re ∧ ρ.re < ((3999999 / 4000000)) ∧ ((23781) : ℝ) < ρ.im ∧ ρ.im < (23812)) ∧
      ...
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((23781)) ((23812))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((23781)) ((23812))) ∧
      (IntervalIntegrable
      ...
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((23781)) ((23812))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((23781)) ((23812))) ∧
      ...
      (IntervalIntegrable (fun y : ℝ => E (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((23781)) ((23812))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((23781)) ((23812))) ∧
      ((∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((23781) : ℝ) : ℂ) * I))
          ...
          + I • (∫ y in ((23781) : ℝ)..(23812), logDeriv riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I))
          - I • (∫ y in ((23781) : ℝ)..(23812), logDeriv riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I))
        = 2 * π * I * (42 : ℂ))) :
  ...
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    ...
    have hle : Real.sqrt ((9060378447999996000001 / 32000000000000)) ≤
  ...
  have hTcard : T.card = 42 := by
    ...
    rfl
  have hb1 : ((23781) : ℝ) ≤ x1 := hlo
  have hb2 : ((23781) : ℝ) ≤ x2 := le_trans hb1 (le_of_lt hc12)
  have hb3 : ((23781) : ℝ) ≤ x3 := le_trans hb2 (le_of_lt hc23)
  have hb4 : ((23781) : ℝ) ≤ x4 := le_trans hb3 (le_of_lt hc34)
  have hb5 : ((23781) : ℝ) ≤ x5 := le_trans hb4 (le_of_lt hc45)
  have hb6 : ((23781) : ℝ) ≤ x6 := le_trans hb5 (le_of_lt hc56)
  have hb7 : ((23781) : ℝ) ≤ x7 := le_trans hb6 (le_of_lt hc67)
  have hb8 : ((23781) : ℝ) ≤ x8 := le_trans hb7 (le_of_lt hc78)
  have hb9 : ((23781) : ℝ) ≤ x9 := le_trans hb8 (le_of_lt hc89)
  have hb10 : ((23781) : ℝ) ≤ x10 := le_trans hb9 (le_of_lt hc910)
  have hb11 : ((23781) : ℝ) ≤ x11 := le_trans hb10 (le_of_lt hc1011)
  have hb12 : ((23781) : ℝ) ≤ x12 := le_trans hb11 (le_of_lt hc1112)
  have hb13 : ((23781) : ℝ) ≤ x13 := le_trans hb12 (le_of_lt hc1213)
  have hb14 : ((23781) : ℝ) ≤ x14 := le_trans hb13 (le_of_lt hc1314)
  have hb15 : ((23781) : ℝ) ≤ x15 := le_trans hb14 (le_of_lt hc1415)
  have hb16 : ((23781) : ℝ) ≤ x16 := le_trans hb15 (le_of_lt hc1516)
  have hb17 : ((23781) : ℝ) ≤ x17 := le_trans hb16 (le_of_lt hc1617)
  have hb18 : ((23781) : ℝ) ≤ x18 := le_trans hb17 (le_of_lt hc1718)
  have hb19 : ((23781) : ℝ) ≤ x19 := le_trans hb18 (le_of_lt hc1819)
  have hb20 : ((23781) : ℝ) ≤ x20 := le_trans hb19 (le_of_lt hc1920)
  have hb21 : ((23781) : ℝ) ≤ x21 := le_trans hb20 (le_of_lt hc2021)
  have hb22 : ((23781) : ℝ) ≤ x22 := le_trans hb21 (le_of_lt hc2122)
  have hb23 : ((23781) : ℝ) ≤ x23 := le_trans hb22 (le_of_lt hc2223)
  have hb24 : ((23781) : ℝ) ≤ x24 := le_trans hb23 (le_of_lt hc2324)
  have hb25 : ((23781) : ℝ) ≤ x25 := le_trans hb24 (le_of_lt hc2425)
  have hb26 : ((23781) : ℝ) ≤ x26 := le_trans hb25 (le_of_lt hc2526)
  have hb27 : ((23781) : ℝ) ≤ x27 := le_trans hb26 (le_of_lt hc2627)
  have hb28 : ((23781) : ℝ) ≤ x28 := le_trans hb27 (le_of_lt hc2728)
  have hb29 : ((23781) : ℝ) ≤ x29 := le_trans hb28 (le_of_lt hc2829)
  have hb30 : ((23781) : ℝ) ≤ x30 := le_trans hb29 (le_of_lt hc2930)
  have hb31 : ((23781) : ℝ) ≤ x31 := le_trans hb30 (le_of_lt hc3031)
  have hb32 : ((23781) : ℝ) ≤ x32 := le_trans hb31 (le_of_lt hc3132)
  have hb33 : ((23781) : ℝ) ≤ x33 := le_trans hb32 (le_of_lt hc3233)
  have hb34 : ((23781) : ℝ) ≤ x34 := le_trans hb33 (le_of_lt hc3334)
  have hb35 : ((23781) : ℝ) ≤ x35 := le_trans hb34 (le_of_lt hc3435)
  have hb36 : ((23781) : ℝ) ≤ x36 := le_trans hb35 (le_of_lt hc3536)
  have hb37 : ((23781) : ℝ) ≤ x37 := le_trans hb36 (le_of_lt hc3637)
  have hb38 : ((23781) : ℝ) ≤ x38 := le_trans hb37 (le_of_lt hc3738)
  have hb39 : ((23781) : ℝ) ≤ x39 := le_trans hb38 (le_of_lt hc3839)
  have hb40 : ((23781) : ℝ) ≤ x40 := le_trans hb39 (le_of_lt hc3940)
  have hb41 : ((23781) : ℝ) ≤ x41 := le_trans hb40 (le_of_lt hc4041)
  have hb42 : ((23781) : ℝ) ≤ x42 := le_trans hb41 (le_of_lt hc4142)
  have hu42 : x42 ≤ ((23812) : ℝ) := hhi
  have hu41 : x41 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc4142) hu42
  have hu40 : x40 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc4041) hu41
  have hu39 : x39 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3940) hu40
  have hu38 : x38 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3839) hu39
  have hu37 : x37 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3738) hu38
  have hu36 : x36 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3637) hu37
  have hu35 : x35 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3536) hu36
  have hu34 : x34 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3435) hu35
  have hu33 : x33 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3334) hu34
  have hu32 : x32 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3233) hu33
  have hu31 : x31 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3132) hu32
  have hu30 : x30 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc3031) hu31
  have hu29 : x29 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2930) hu30
  have hu28 : x28 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2829) hu29
  have hu27 : x27 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2728) hu28
  have hu26 : x26 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2627) hu27
  have hu25 : x25 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2526) hu26
  have hu24 : x24 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2425) hu25
  have hu23 : x23 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2324) hu24
  have hu22 : x22 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2223) hu23
  have hu21 : x21 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2122) hu22
  have hu20 : x20 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc2021) hu21
  have hu19 : x19 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1920) hu20
  have hu18 : x18 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1819) hu19
  have hu17 : x17 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1718) hu18
  have hu16 : x16 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1617) hu17
  have hu15 : x15 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1516) hu16
  have hu14 : x14 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1415) hu15
  have hu13 : x13 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1314) hu14
  have hu12 : x12 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1213) hu13
  have hu11 : x11 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1112) hu12
  have hu10 : x10 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc1011) hu11
  have hu9 : x9 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc910) hu10
  have hu8 : x8 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc89) hu9
  have hu7 : x7 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc78) hu8
  have hu6 : x6 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc67) hu7
  have hu5 : x5 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc56) hu6
  have hu4 : x4 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc45) hu5
  have hu3 : x3 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc34) hu4
  have hu2 : x2 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc23) hu3
  have hu1 : x1 ≤ ((23812) : ℝ) := le_trans (le_of_lt hc12) hu2
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) (23781) (23812) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) ×ℂ Set.Icc ((23781) : ℝ) (23812)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((23781) : ℝ) : ℂ) * I))
        - (∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((23812) : ℝ) : ℂ) * I))
        + I • (∫ y in ((23781) : ℝ)..(23812), logDeriv riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I))
        - I • (∫ y in ((23781) : ℝ)..(23812), logDeriv riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((42 : ℤ) : ℂ) := by
  ...
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((23812) : ℝ) : ℂ) * I)) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((23781)) ((23812))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((23781)) ((23812))) := by
  ...
  exact RHInBox.rh_in_box_of_certificate (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) (23781) (23812) cPB RPB 42
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d4000000_3999999d4000000_23781_23812
