/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 4000000),(3999999 / 4000000)] x [19065,19097]` with `N = 41` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (19081)*I`, radius `R = Real.sqrt ((5825357079999996000001 / 32000000000000))`,
...
namespace RHInBox_1d4000000_3999999d4000000_19065_19097

/-- Chosen Blaschke ball center for the box `[(1 / 4000000),(3999999 / 4000000)] x [19065,19097]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (19081)⟩

/-- Chosen Blaschke ball radius (squared radius `(5825357079999996000001 / 32000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((5825357079999996000001 / 32000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 4000000),(3999999 / 4000000)] x [19065,19097]` with `N = 41`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (19081)*I`, `R = Real.sqrt ((5825357079999996000001 / 32000000000000))`, and count `N = 41`.  Takes the
...
theorem rh_in_box_1d4000000_3999999d4000000_19065_19097
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      DifferentiableOn ℂ E (Set.Icc (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) ×ℂ Set.Icc ((19065) : ℝ) (19097)) →
      ...
      (∀ y ∈ Set.uIcc ((19065) : ℝ) (19097), riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((19065) : ℝ) (19097), riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ ρ ∈ s, (((1 / 4000000)) : ℝ) < ρ.re ∧ ρ.re < ((3999999 / 4000000)) ∧ ((19065) : ℝ) < ρ.im ∧ ρ.im < (19097)) ∧
      ...
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((19065)) ((19097))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((19065)) ((19097))) ∧
      (IntervalIntegrable
      ...
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((19065)) ((19097))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((19065)) ((19097))) ∧
      ...
      (IntervalIntegrable (fun y : ℝ => E (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((19065)) ((19097))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((19065)) ((19097))) ∧
      ((∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((19065) : ℝ) : ℂ) * I))
          ...
          + I • (∫ y in ((19065) : ℝ)..(19097), logDeriv riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I))
          - I • (∫ y in ((19065) : ℝ)..(19097), logDeriv riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I))
        = 2 * π * I * (41 : ℂ))) :
  ...
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    ...
    have hle : Real.sqrt ((5825357079999996000001 / 32000000000000)) ≤
  ...
  have hTcard : T.card = 41 := by
    ...
    rfl
  have hb1 : ((19065) : ℝ) ≤ x1 := hlo
  have hb2 : ((19065) : ℝ) ≤ x2 := le_trans hb1 (le_of_lt hc12)
  have hb3 : ((19065) : ℝ) ≤ x3 := le_trans hb2 (le_of_lt hc23)
  have hb4 : ((19065) : ℝ) ≤ x4 := le_trans hb3 (le_of_lt hc34)
  have hb5 : ((19065) : ℝ) ≤ x5 := le_trans hb4 (le_of_lt hc45)
  have hb6 : ((19065) : ℝ) ≤ x6 := le_trans hb5 (le_of_lt hc56)
  have hb7 : ((19065) : ℝ) ≤ x7 := le_trans hb6 (le_of_lt hc67)
  have hb8 : ((19065) : ℝ) ≤ x8 := le_trans hb7 (le_of_lt hc78)
  have hb9 : ((19065) : ℝ) ≤ x9 := le_trans hb8 (le_of_lt hc89)
  have hb10 : ((19065) : ℝ) ≤ x10 := le_trans hb9 (le_of_lt hc910)
  have hb11 : ((19065) : ℝ) ≤ x11 := le_trans hb10 (le_of_lt hc1011)
  have hb12 : ((19065) : ℝ) ≤ x12 := le_trans hb11 (le_of_lt hc1112)
  have hb13 : ((19065) : ℝ) ≤ x13 := le_trans hb12 (le_of_lt hc1213)
  have hb14 : ((19065) : ℝ) ≤ x14 := le_trans hb13 (le_of_lt hc1314)
  have hb15 : ((19065) : ℝ) ≤ x15 := le_trans hb14 (le_of_lt hc1415)
  have hb16 : ((19065) : ℝ) ≤ x16 := le_trans hb15 (le_of_lt hc1516)
  have hb17 : ((19065) : ℝ) ≤ x17 := le_trans hb16 (le_of_lt hc1617)
  have hb18 : ((19065) : ℝ) ≤ x18 := le_trans hb17 (le_of_lt hc1718)
  have hb19 : ((19065) : ℝ) ≤ x19 := le_trans hb18 (le_of_lt hc1819)
  have hb20 : ((19065) : ℝ) ≤ x20 := le_trans hb19 (le_of_lt hc1920)
  have hb21 : ((19065) : ℝ) ≤ x21 := le_trans hb20 (le_of_lt hc2021)
  have hb22 : ((19065) : ℝ) ≤ x22 := le_trans hb21 (le_of_lt hc2122)
  have hb23 : ((19065) : ℝ) ≤ x23 := le_trans hb22 (le_of_lt hc2223)
  have hb24 : ((19065) : ℝ) ≤ x24 := le_trans hb23 (le_of_lt hc2324)
  have hb25 : ((19065) : ℝ) ≤ x25 := le_trans hb24 (le_of_lt hc2425)
  have hb26 : ((19065) : ℝ) ≤ x26 := le_trans hb25 (le_of_lt hc2526)
  have hb27 : ((19065) : ℝ) ≤ x27 := le_trans hb26 (le_of_lt hc2627)
  have hb28 : ((19065) : ℝ) ≤ x28 := le_trans hb27 (le_of_lt hc2728)
  have hb29 : ((19065) : ℝ) ≤ x29 := le_trans hb28 (le_of_lt hc2829)
  have hb30 : ((19065) : ℝ) ≤ x30 := le_trans hb29 (le_of_lt hc2930)
  have hb31 : ((19065) : ℝ) ≤ x31 := le_trans hb30 (le_of_lt hc3031)
  have hb32 : ((19065) : ℝ) ≤ x32 := le_trans hb31 (le_of_lt hc3132)
  have hb33 : ((19065) : ℝ) ≤ x33 := le_trans hb32 (le_of_lt hc3233)
  have hb34 : ((19065) : ℝ) ≤ x34 := le_trans hb33 (le_of_lt hc3334)
  have hb35 : ((19065) : ℝ) ≤ x35 := le_trans hb34 (le_of_lt hc3435)
  have hb36 : ((19065) : ℝ) ≤ x36 := le_trans hb35 (le_of_lt hc3536)
  have hb37 : ((19065) : ℝ) ≤ x37 := le_trans hb36 (le_of_lt hc3637)
  have hb38 : ((19065) : ℝ) ≤ x38 := le_trans hb37 (le_of_lt hc3738)
  have hb39 : ((19065) : ℝ) ≤ x39 := le_trans hb38 (le_of_lt hc3839)
  have hb40 : ((19065) : ℝ) ≤ x40 := le_trans hb39 (le_of_lt hc3940)
  have hb41 : ((19065) : ℝ) ≤ x41 := le_trans hb40 (le_of_lt hc4041)
  have hu41 : x41 ≤ ((19097) : ℝ) := hhi
  have hu40 : x40 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc4041) hu41
  have hu39 : x39 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3940) hu40
  have hu38 : x38 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3839) hu39
  have hu37 : x37 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3738) hu38
  have hu36 : x36 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3637) hu37
  have hu35 : x35 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3536) hu36
  have hu34 : x34 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3435) hu35
  have hu33 : x33 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3334) hu34
  have hu32 : x32 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3233) hu33
  have hu31 : x31 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3132) hu32
  have hu30 : x30 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc3031) hu31
  have hu29 : x29 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2930) hu30
  have hu28 : x28 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2829) hu29
  have hu27 : x27 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2728) hu28
  have hu26 : x26 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2627) hu27
  have hu25 : x25 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2526) hu26
  have hu24 : x24 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2425) hu25
  have hu23 : x23 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2324) hu24
  have hu22 : x22 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2223) hu23
  have hu21 : x21 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2122) hu22
  have hu20 : x20 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc2021) hu21
  have hu19 : x19 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1920) hu20
  have hu18 : x18 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1819) hu19
  have hu17 : x17 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1718) hu18
  have hu16 : x16 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1617) hu17
  have hu15 : x15 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1516) hu16
  have hu14 : x14 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1415) hu15
  have hu13 : x13 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1314) hu14
  have hu12 : x12 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1213) hu13
  have hu11 : x11 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1112) hu12
  have hu10 : x10 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc1011) hu11
  have hu9 : x9 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc910) hu10
  have hu8 : x8 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc89) hu9
  have hu7 : x7 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc78) hu8
  have hu6 : x6 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc67) hu7
  have hu5 : x5 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc56) hu6
  have hu4 : x4 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc45) hu5
  have hu3 : x3 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc34) hu4
  have hu2 : x2 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc23) hu3
  have hu1 : x1 ≤ ((19097) : ℝ) := le_trans (le_of_lt hc12) hu2
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) (19065) (19097) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) ×ℂ Set.Icc ((19065) : ℝ) (19097)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((19065) : ℝ) : ℂ) * I))
        - (∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((19097) : ℝ) : ℂ) * I))
        + I • (∫ y in ((19065) : ℝ)..(19097), logDeriv riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I))
        - I • (∫ y in ((19065) : ℝ)..(19097), logDeriv riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((41 : ℤ) : ℂ) := by
  ...
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((19097) : ℝ) : ℂ) * I)) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((19065)) ((19097))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((19065)) ((19097))) := by
  ...
  exact RHInBox.rh_in_box_of_certificate (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) (19065) (19097) cPB RPB 41
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d4000000_3999999d4000000_19065_19097
