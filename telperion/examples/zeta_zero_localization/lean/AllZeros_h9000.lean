...
/-- The 28-band partition of `[8000, 9000]`. -/
...
theorem segment_8000_9000
  ...
  have hre' : ((1 / 4000000) : ℝ) ≤ ρ.re ∧ ρ.re ≤ 3999999 / 4000000 := by
    ...
    linarith [h2, hre_eq]
  interval_cases i
  · exact hseg0 ρ hre' ⟨le_trans (show ((8000) : ℝ) ≤ (8000) by norm_num) him.1, le_trans him.2 (show ((8036) : ℝ) ≤ (8036) by norm_num)⟩ hz
  · exact hseg1 ρ hre' ⟨le_trans (show ((32143 / 4) : ℝ) ≤ (8036) by norm_num) him.1, le_trans him.2 (show ((8071) : ℝ) ≤ (8071) by norm_num)⟩ hz
  · exact hseg2 ρ hre' ⟨le_trans (show ((8071) : ℝ) ≤ (8071) by norm_num) him.1, le_trans him.2 (show ((8107) : ℝ) ≤ (8107) by norm_num)⟩ hz
  · exact hseg3 ρ hre' ⟨le_trans (show ((32427 / 4) : ℝ) ≤ (8107) by norm_num) him.1, le_trans him.2 (show ((8143) : ℝ) ≤ (8143) by norm_num)⟩ hz
  · exact hseg4 ρ hre' ⟨le_trans (show ((8143) : ℝ) ≤ (8143) by norm_num) him.1, le_trans him.2 (show ((8179) : ℝ) ≤ (8179) by norm_num)⟩ hz
  · exact hseg5 ρ hre' ⟨le_trans (show ((8179) : ℝ) ≤ (8179) by norm_num) him.1, le_trans him.2 (show ((8214) : ℝ) ≤ (8214) by norm_num)⟩ hz
  · exact hseg6 ρ hre' ⟨le_trans (show ((8214) : ℝ) ≤ (8214) by norm_num) him.1, le_trans him.2 (show ((8250) : ℝ) ≤ (8250) by norm_num)⟩ hz
  · exact hseg7 ρ hre' ⟨le_trans (show ((8250) : ℝ) ≤ (8250) by norm_num) him.1, le_trans him.2 (show ((8286) : ℝ) ≤ (8286) by norm_num)⟩ hz
  · exact hseg8 ρ hre' ⟨le_trans (show ((8286) : ℝ) ≤ (8286) by norm_num) him.1, le_trans him.2 (show ((8321) : ℝ) ≤ (8321) by norm_num)⟩ hz
  · exact hseg9 ρ hre' ⟨le_trans (show ((8321) : ℝ) ≤ (8321) by norm_num) him.1, le_trans him.2 (show ((8357) : ℝ) ≤ (8357) by norm_num)⟩ hz
  · exact hseg10 ρ hre' ⟨le_trans (show ((8357) : ℝ) ≤ (8357) by norm_num) him.1, le_trans him.2 (show ((8393) : ℝ) ≤ (8393) by norm_num)⟩ hz
  · exact hseg11 ρ hre' ⟨le_trans (show ((8393) : ℝ) ≤ (8393) by norm_num) him.1, le_trans him.2 (show ((8429) : ℝ) ≤ (8429) by norm_num)⟩ hz
  · exact hseg12 ρ hre' ⟨le_trans (show ((8429) : ℝ) ≤ (8429) by norm_num) him.1, le_trans him.2 (show ((8464) : ℝ) ≤ (8464) by norm_num)⟩ hz
  · exact hseg13 ρ hre' ⟨le_trans (show ((8464) : ℝ) ≤ (8464) by norm_num) him.1, le_trans him.2 (show ((8500) : ℝ) ≤ (8500) by norm_num)⟩ hz
  · exact hseg14 ρ hre' ⟨le_trans (show ((8500) : ℝ) ≤ (8500) by norm_num) him.1, le_trans him.2 (show ((8536) : ℝ) ≤ (34145 / 4) by norm_num)⟩ hz
  · exact hseg15 ρ hre' ⟨le_trans (show ((8536) : ℝ) ≤ (8536) by norm_num) him.1, le_trans him.2 (show ((8571) : ℝ) ≤ (8571) by norm_num)⟩ hz
  · exact hseg16 ρ hre' ⟨le_trans (show ((34283 / 4) : ℝ) ≤ (8571) by norm_num) him.1, le_trans him.2 (show ((8607) : ℝ) ≤ (8607) by norm_num)⟩ hz
  · exact hseg17 ρ hre' ⟨le_trans (show ((8607) : ℝ) ≤ (8607) by norm_num) him.1, le_trans him.2 (show ((8643) : ℝ) ≤ (8643) by norm_num)⟩ hz
  · exact hseg18 ρ hre' ⟨le_trans (show ((8643) : ℝ) ≤ (8643) by norm_num) him.1, le_trans him.2 (show ((8679) : ℝ) ≤ (8679) by norm_num)⟩ hz
  · exact hseg19 ρ hre' ⟨le_trans (show ((8679) : ℝ) ≤ (8679) by norm_num) him.1, le_trans him.2 (show ((8714) : ℝ) ≤ (34857 / 4) by norm_num)⟩ hz
  · exact hseg20 ρ hre' ⟨le_trans (show ((8714) : ℝ) ≤ (8714) by norm_num) him.1, le_trans him.2 (show ((8750) : ℝ) ≤ (8750) by norm_num)⟩ hz
  · exact hseg21 ρ hre' ⟨le_trans (show ((8750) : ℝ) ≤ (8750) by norm_num) him.1, le_trans him.2 (show ((8786) : ℝ) ≤ (35145 / 4) by norm_num)⟩ hz
  · exact hseg22 ρ hre' ⟨le_trans (show ((8786) : ℝ) ≤ (8786) by norm_num) him.1, le_trans him.2 (show ((8821) : ℝ) ≤ (8821) by norm_num)⟩ hz
  · exact hseg23 ρ hre' ⟨le_trans (show ((8821) : ℝ) ≤ (8821) by norm_num) him.1, le_trans him.2 (show ((8857) : ℝ) ≤ (8857) by norm_num)⟩ hz
  · exact hseg24 ρ hre' ⟨le_trans (show ((8857) : ℝ) ≤ (8857) by norm_num) him.1, le_trans him.2 (show ((8893) : ℝ) ≤ (8893) by norm_num)⟩ hz
  · exact hseg25 ρ hre' ⟨le_trans (show ((8893) : ℝ) ≤ (8893) by norm_num) him.1, le_trans him.2 (show ((8929) : ℝ) ≤ (8929) by norm_num)⟩ hz
  · exact hseg26 ρ hre' ⟨le_trans (show ((8929) : ℝ) ≤ (8929) by norm_num) him.1, le_trans him.2 (show ((8964) : ℝ) ≤ (8964) by norm_num)⟩ hz
  · exact hseg27 ρ hre' ⟨le_trans (show ((8964) : ℝ) ≤ (8964) by norm_num) him.1, le_trans him.2 (show ((9000) : ℝ) ≤ (9000) by norm_num)⟩ hz
