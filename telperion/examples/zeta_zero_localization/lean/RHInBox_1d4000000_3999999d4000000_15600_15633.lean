/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 4000000),(3999999 / 4000000)] x [15600,15633]` with `N = 40` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + ((31233 / 2))*I`, radius `R = Real.sqrt ((3902005519999996000001 / 32000000000000))`,
...
namespace RHInBox_1d4000000_3999999d4000000_15600_15633

/-- Chosen Blaschke ball center for the box `[(1 / 4000000),(3999999 / 4000000)] x [15600,15633]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), ((31233 / 2))⟩

/-- Chosen Blaschke ball radius (squared radius `(3902005519999996000001 / 32000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((3902005519999996000001 / 32000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 4000000),(3999999 / 4000000)] x [15600,15633]` with `N = 40`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + ((31233 / 2))*I`, `R = Real.sqrt ((3902005519999996000001 / 32000000000000))`, and count `N = 40`.  Takes the
    documented Arb inputs `hLine` (the 40 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*40`).  conjecture1_proved = False. -/
theorem rh_in_box_1d4000000_3999999d4000000_15600_15633
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      DifferentiableOn ℂ E (Set.Icc (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) ×ℂ Set.Icc ((15600) : ℝ) (15633)) →
      (∀ z ∈ Metric.ball cPB RPB, riemannZeta z ≠ 0 →
        logDeriv riemannZeta z = (∑ ρ ∈ s, (d ρ : ℂ) / (z - ρ)) + E z) →
      (∀ x ∈ Set.uIcc (((1 / 4000000)) : ℝ) ((3999999 / 4000000)), riemannZeta (↑x + (((15600) : ℝ) : ℂ) * I) ≠ 0) ∧
      (∀ x ∈ Set.uIcc (((1 / 4000000)) : ℝ) ((3999999 / 4000000)), riemannZeta (↑x + (((15633) : ℝ) : ℂ) * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((15600) : ℝ) (15633), riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ y ∈ Set.uIcc ((15600) : ℝ) (15633), riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) ≠ 0) ∧
      (∀ ρ ∈ s, (((1 / 4000000)) : ℝ) < ρ.re ∧ ρ.re < ((3999999 / 4000000)) ∧ ((15600) : ℝ) < ρ.im ∧ ρ.im < (15633)) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun x : ℝ => ((↑x + (((15600) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun x : ℝ => ((↑x + (((15633) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((15600)) ((15633))) ∧
      (∀ ρ ∈ s, IntervalIntegrable
        (fun y : ℝ => ((((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((15600)) ((15633))) ∧
      (IntervalIntegrable
        (fun x : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((↑x + (((15600) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (IntervalIntegrable
        (fun x : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((↑x + (((15633) : ℝ) : ℂ) * I) - ρ)⁻¹) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((15600)) ((15633))) ∧
      (IntervalIntegrable
        (fun y : ℝ => ∑ ρ ∈ s, (d ρ : ℂ) * ((((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I) - ρ)⁻¹) volume ((15600)) ((15633))) ∧
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((15600) : ℝ) : ℂ) * I)) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((15633) : ℝ) : ℂ) * I)) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((15600)) ((15633))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((15600)) ((15633))) ∧
      ((∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((15600) : ℝ) : ℂ) * I))
          - (∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((15633) : ℝ) : ℂ) * I))
          + I • (∫ y in ((15600) : ℝ)..(15633), logDeriv riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I))
          - I • (∫ y in ((15600) : ℝ)..(15633), logDeriv riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I))
        = 2 * π * I * (40 : ℂ))) :
    (∀ ρ, ((((1 / 4000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((3999999 / 4000000))) → (((15600) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (15633)) →
      riemannZeta ρ = 0 → ρ.re = 1 / 2) := by
  have hRpos : (0 : ℝ) < RPB := RPB_pos
  have hsig : (((1 / 4000000)) : ℝ) ≤ ((3999999 / 4000000)) := by norm_num
  have hTle : ((15600) : ℝ) ≤ (15633) := by norm_num
  have hbox_ball : ∀ ρ : ℂ, ((((1 / 4000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((3999999 / 4000000))) →
      (((15600) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (15633)) → ρ ∈ Metric.ball cPB RPB := by
    intro ρ hre him
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    apply Real.sqrt_lt_sqrt (by positivity)
    have h1 := hre.1; have h2 := hre.2; have h3 := him.1; have h4 := him.2
    nlinarith [h1, h2, h3, h4, sq_nonneg (ρ.re - ((1 / 2))), sq_nonneg (ρ.im - ((31233 / 2)))]
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    intro hlt
    simp only [Complex.one_re, Complex.one_im] at hlt
    have hle : Real.sqrt ((3902005519999996000001 / 32000000000000)) ≤
        Real.sqrt (((1 : ℝ) - ((1 / 2))) ^ 2 + ((0 : ℝ) - ((31233 / 2))) ^ 2) :=
  ...
  have hTcard : T.card = 40 := by
    ...
    rfl
  have hb1 : ((15600) : ℝ) ≤ x1 := hlo
  have hb2 : ((15600) : ℝ) ≤ x2 := le_trans hb1 (le_of_lt hc12)
  have hb3 : ((15600) : ℝ) ≤ x3 := le_trans hb2 (le_of_lt hc23)
  have hb4 : ((15600) : ℝ) ≤ x4 := le_trans hb3 (le_of_lt hc34)
  have hb5 : ((15600) : ℝ) ≤ x5 := le_trans hb4 (le_of_lt hc45)
  have hb6 : ((15600) : ℝ) ≤ x6 := le_trans hb5 (le_of_lt hc56)
  have hb7 : ((15600) : ℝ) ≤ x7 := le_trans hb6 (le_of_lt hc67)
  have hb8 : ((15600) : ℝ) ≤ x8 := le_trans hb7 (le_of_lt hc78)
  have hb9 : ((15600) : ℝ) ≤ x9 := le_trans hb8 (le_of_lt hc89)
  have hb10 : ((15600) : ℝ) ≤ x10 := le_trans hb9 (le_of_lt hc910)
  have hb11 : ((15600) : ℝ) ≤ x11 := le_trans hb10 (le_of_lt hc1011)
  have hb12 : ((15600) : ℝ) ≤ x12 := le_trans hb11 (le_of_lt hc1112)
  have hb13 : ((15600) : ℝ) ≤ x13 := le_trans hb12 (le_of_lt hc1213)
  have hb14 : ((15600) : ℝ) ≤ x14 := le_trans hb13 (le_of_lt hc1314)
  have hb15 : ((15600) : ℝ) ≤ x15 := le_trans hb14 (le_of_lt hc1415)
  have hb16 : ((15600) : ℝ) ≤ x16 := le_trans hb15 (le_of_lt hc1516)
  have hb17 : ((15600) : ℝ) ≤ x17 := le_trans hb16 (le_of_lt hc1617)
  have hb18 : ((15600) : ℝ) ≤ x18 := le_trans hb17 (le_of_lt hc1718)
  have hb19 : ((15600) : ℝ) ≤ x19 := le_trans hb18 (le_of_lt hc1819)
  have hb20 : ((15600) : ℝ) ≤ x20 := le_trans hb19 (le_of_lt hc1920)
  have hb21 : ((15600) : ℝ) ≤ x21 := le_trans hb20 (le_of_lt hc2021)
  have hb22 : ((15600) : ℝ) ≤ x22 := le_trans hb21 (le_of_lt hc2122)
  have hb23 : ((15600) : ℝ) ≤ x23 := le_trans hb22 (le_of_lt hc2223)
  have hb24 : ((15600) : ℝ) ≤ x24 := le_trans hb23 (le_of_lt hc2324)
  have hb25 : ((15600) : ℝ) ≤ x25 := le_trans hb24 (le_of_lt hc2425)
  have hb26 : ((15600) : ℝ) ≤ x26 := le_trans hb25 (le_of_lt hc2526)
  have hb27 : ((15600) : ℝ) ≤ x27 := le_trans hb26 (le_of_lt hc2627)
  have hb28 : ((15600) : ℝ) ≤ x28 := le_trans hb27 (le_of_lt hc2728)
  have hb29 : ((15600) : ℝ) ≤ x29 := le_trans hb28 (le_of_lt hc2829)
  have hb30 : ((15600) : ℝ) ≤ x30 := le_trans hb29 (le_of_lt hc2930)
  have hb31 : ((15600) : ℝ) ≤ x31 := le_trans hb30 (le_of_lt hc3031)
  have hb32 : ((15600) : ℝ) ≤ x32 := le_trans hb31 (le_of_lt hc3132)
  have hb33 : ((15600) : ℝ) ≤ x33 := le_trans hb32 (le_of_lt hc3233)
  have hb34 : ((15600) : ℝ) ≤ x34 := le_trans hb33 (le_of_lt hc3334)
  have hb35 : ((15600) : ℝ) ≤ x35 := le_trans hb34 (le_of_lt hc3435)
  have hb36 : ((15600) : ℝ) ≤ x36 := le_trans hb35 (le_of_lt hc3536)
  have hb37 : ((15600) : ℝ) ≤ x37 := le_trans hb36 (le_of_lt hc3637)
  have hb38 : ((15600) : ℝ) ≤ x38 := le_trans hb37 (le_of_lt hc3738)
  have hb39 : ((15600) : ℝ) ≤ x39 := le_trans hb38 (le_of_lt hc3839)
  have hb40 : ((15600) : ℝ) ≤ x40 := le_trans hb39 (le_of_lt hc3940)
  have hu40 : x40 ≤ ((15633) : ℝ) := hhi
  have hu39 : x39 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3940) hu40
  have hu38 : x38 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3839) hu39
  have hu37 : x37 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3738) hu38
  have hu36 : x36 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3637) hu37
  have hu35 : x35 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3536) hu36
  have hu34 : x34 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3435) hu35
  have hu33 : x33 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3334) hu34
  have hu32 : x32 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3233) hu33
  have hu31 : x31 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3132) hu32
  have hu30 : x30 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc3031) hu31
  have hu29 : x29 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2930) hu30
  have hu28 : x28 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2829) hu29
  have hu27 : x27 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2728) hu28
  have hu26 : x26 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2627) hu27
  have hu25 : x25 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2526) hu26
  have hu24 : x24 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2425) hu25
  have hu23 : x23 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2324) hu24
  have hu22 : x22 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2223) hu23
  have hu21 : x21 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2122) hu22
  have hu20 : x20 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc2021) hu21
  have hu19 : x19 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1920) hu20
  have hu18 : x18 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1819) hu19
  have hu17 : x17 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1718) hu18
  have hu16 : x16 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1617) hu17
  have hu15 : x15 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1516) hu16
  have hu14 : x14 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1415) hu15
  have hu13 : x13 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1314) hu14
  have hu12 : x12 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1213) hu13
  have hu11 : x11 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1112) hu12
  have hu10 : x10 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc1011) hu11
  have hu9 : x9 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc910) hu10
  have hu8 : x8 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc89) hu9
  have hu7 : x7 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc78) hu8
  have hu6 : x6 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc67) hu7
  have hu5 : x5 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc56) hu6
  have hu4 : x4 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc45) hu5
  have hu3 : x3 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc34) hu4
  have hu2 : x2 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc23) hu3
  have hu1 : x1 ≤ ((15633) : ℝ) := le_trans (le_of_lt hc12) hu2
  ...
  have hTbox : ∀ z ∈ T, ((((1 / 4000000)) : ℝ) ≤ z.re ∧ z.re ≤ ((3999999 / 4000000))) ∧ (((15600) : ℝ) ≤ z.im ∧ z.im ≤ (15633)) := by
    rw [hTdef]
    refine RHInBox.line_toFinset_forall xsL ?_
    rw [hxsdef]
    simp only [List.forall_mem_cons]
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) (15600) (15633) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) ×ℂ Set.Icc ((15600) : ℝ) (15633)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((15600) : ℝ) : ℂ) * I))
        - (∫ x in (((1 / 4000000)) : ℝ)..((3999999 / 4000000)), logDeriv riemannZeta (↑x + (((15633) : ℝ) : ℂ) * I))
        + I • (∫ y in ((15600) : ℝ)..(15633), logDeriv riemannZeta (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I))
        - I • (∫ y in ((15600) : ℝ)..(15633), logDeriv riemannZeta (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((40 : ℤ) : ℂ) := by
  ...
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((15633) : ℝ) : ℂ) * I)) volume (((1 / 4000000))) (((3999999 / 4000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((3999999 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((15600)) ((15633))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 4000000)) : ℝ) : ℂ) + ↑y * I)) volume ((15600)) ((15633))) := by
  ...
  exact RHInBox.rh_in_box_of_certificate (((1 / 4000000)) : ℝ) ((3999999 / 4000000)) (15600) (15633) cPB RPB 40
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d4000000_3999999d4000000_15600_15633
