...
/-- The 27-band partition of `[7000, 8000]`. -/
...
theorem segment_7000_8000
  ...
  have hre' : ((1 / 4000000) : ℝ) ≤ ρ.re ∧ ρ.re ≤ 3999999 / 4000000 := by
    ...
    linarith [h2, hre_eq]
  interval_cases i
  · exact hseg0 ρ hre' ⟨le_trans (show ((7000) : ℝ) ≤ (7000) by norm_num) him.1, le_trans him.2 (show ((7037) : ℝ) ≤ (7037) by norm_num)⟩ hz
  · exact hseg1 ρ hre' ⟨le_trans (show ((7037) : ℝ) ≤ (7037) by norm_num) him.1, le_trans him.2 (show ((7074) : ℝ) ≤ (7074) by norm_num)⟩ hz
  · exact hseg2 ρ hre' ⟨le_trans (show ((7074) : ℝ) ≤ (7074) by norm_num) him.1, le_trans him.2 (show ((7111) : ℝ) ≤ (7111) by norm_num)⟩ hz
  · exact hseg3 ρ hre' ⟨le_trans (show ((7111) : ℝ) ≤ (7111) by norm_num) him.1, le_trans him.2 (show ((7148) : ℝ) ≤ (7148) by norm_num)⟩ hz
  · exact hseg4 ρ hre' ⟨le_trans (show ((7148) : ℝ) ≤ (7148) by norm_num) him.1, le_trans him.2 (show ((7185) : ℝ) ≤ (7185) by norm_num)⟩ hz
  · exact hseg5 ρ hre' ⟨le_trans (show ((7185) : ℝ) ≤ (7185) by norm_num) him.1, le_trans him.2 (show ((7222) : ℝ) ≤ (7222) by norm_num)⟩ hz
  · exact hseg6 ρ hre' ⟨le_trans (show ((7222) : ℝ) ≤ (7222) by norm_num) him.1, le_trans him.2 (show ((7259) : ℝ) ≤ (7259) by norm_num)⟩ hz
  · exact hseg7 ρ hre' ⟨le_trans (show ((7259) : ℝ) ≤ (7259) by norm_num) him.1, le_trans him.2 (show ((7296) : ℝ) ≤ (7296) by norm_num)⟩ hz
  · exact hseg8 ρ hre' ⟨le_trans (show ((7296) : ℝ) ≤ (7296) by norm_num) him.1, le_trans him.2 (show ((7333) : ℝ) ≤ (7333) by norm_num)⟩ hz
  · exact hseg9 ρ hre' ⟨le_trans (show ((7333) : ℝ) ≤ (7333) by norm_num) him.1, le_trans him.2 (show ((7370) : ℝ) ≤ (7370) by norm_num)⟩ hz
  · exact hseg10 ρ hre' ⟨le_trans (show ((7370) : ℝ) ≤ (7370) by norm_num) him.1, le_trans him.2 (show ((7407) : ℝ) ≤ (7407) by norm_num)⟩ hz
  · exact hseg11 ρ hre' ⟨le_trans (show ((7407) : ℝ) ≤ (7407) by norm_num) him.1, le_trans him.2 (show ((7444) : ℝ) ≤ (7444) by norm_num)⟩ hz
  · exact hseg12 ρ hre' ⟨le_trans (show ((7444) : ℝ) ≤ (7444) by norm_num) him.1, le_trans him.2 (show ((7481) : ℝ) ≤ (7481) by norm_num)⟩ hz
  · exact hseg13 ρ hre' ⟨le_trans (show ((7481) : ℝ) ≤ (7481) by norm_num) him.1, le_trans him.2 (show ((7519) : ℝ) ≤ (7519) by norm_num)⟩ hz
  · exact hseg14 ρ hre' ⟨le_trans (show ((30075 / 4) : ℝ) ≤ (7519) by norm_num) him.1, le_trans him.2 (show ((7556) : ℝ) ≤ (7556) by norm_num)⟩ hz
  · exact hseg15 ρ hre' ⟨le_trans (show ((7556) : ℝ) ≤ (7556) by norm_num) him.1, le_trans him.2 (show ((7593) : ℝ) ≤ (7593) by norm_num)⟩ hz
  · exact hseg16 ρ hre' ⟨le_trans (show ((7593) : ℝ) ≤ (7593) by norm_num) him.1, le_trans him.2 (show ((7630) : ℝ) ≤ (7630) by norm_num)⟩ hz
  · exact hseg17 ρ hre' ⟨le_trans (show ((7630) : ℝ) ≤ (7630) by norm_num) him.1, le_trans him.2 (show ((7667) : ℝ) ≤ (7667) by norm_num)⟩ hz
  · exact hseg18 ρ hre' ⟨le_trans (show ((7667) : ℝ) ≤ (7667) by norm_num) him.1, le_trans him.2 (show ((7704) : ℝ) ≤ (7704) by norm_num)⟩ hz
  · exact hseg19 ρ hre' ⟨le_trans (show ((7704) : ℝ) ≤ (7704) by norm_num) him.1, le_trans him.2 (show ((7741) : ℝ) ≤ (7741) by norm_num)⟩ hz
  · exact hseg20 ρ hre' ⟨le_trans (show ((30963 / 4) : ℝ) ≤ (7741) by norm_num) him.1, le_trans him.2 (show ((7778) : ℝ) ≤ (7778) by norm_num)⟩ hz
  · exact hseg21 ρ hre' ⟨le_trans (show ((7778) : ℝ) ≤ (7778) by norm_num) him.1, le_trans him.2 (show ((7815) : ℝ) ≤ (7815) by norm_num)⟩ hz
  · exact hseg22 ρ hre' ⟨le_trans (show ((7815) : ℝ) ≤ (7815) by norm_num) him.1, le_trans him.2 (show ((7852) : ℝ) ≤ (31409 / 4) by norm_num)⟩ hz
  · exact hseg23 ρ hre' ⟨le_trans (show ((7852) : ℝ) ≤ (7852) by norm_num) him.1, le_trans him.2 (show ((7889) : ℝ) ≤ (7889) by norm_num)⟩ hz
  · exact hseg24 ρ hre' ⟨le_trans (show ((7889) : ℝ) ≤ (7889) by norm_num) him.1, le_trans him.2 (show ((7926) : ℝ) ≤ (31705 / 4) by norm_num)⟩ hz
  · exact hseg25 ρ hre' ⟨le_trans (show ((7926) : ℝ) ≤ (7926) by norm_num) him.1, le_trans him.2 (show ((7963) : ℝ) ≤ (7963) by norm_num)⟩ hz
  · exact hseg26 ρ hre' ⟨le_trans (show ((31851 / 4) : ℝ) ≤ (7963) by norm_num) him.1, le_trans him.2 (show ((8000) : ℝ) ≤ (8000) by norm_num)⟩ hz
