/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 2000000),(1999999 / 2000000)] x [100,200]` with `N = 50` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (150)*I`, radius `R = Real.sqrt ((100001999998000001 / 8000000000000))`,
...
namespace RHInBox_1d2000000_1999999d2000000_100_200

/-- Chosen Blaschke ball center for the box `[(1 / 2000000),(1999999 / 2000000)] x [100,200]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (150)⟩

/-- Chosen Blaschke ball radius (squared radius `(100001999998000001 / 8000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((100001999998000001 / 8000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 2000000),(1999999 / 2000000)] x [100,200]` with `N = 50`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (150)*I`, `R = Real.sqrt ((100001999998000001 / 8000000000000))`, and count `N = 50`.  Takes the
    documented Arb inputs `hLine` (the 50 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*50`).  conjecture1_proved = False. -/
theorem rh_in_box_1d2000000_1999999d2000000_100_200
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      ...
      ((∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((100) : ℝ) : ℂ) * I))
        ...
        = 2 * π * I * (50 : ℂ))) :
    (∀ ρ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) → (((100) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (200)) →
  ...
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    ...
    have hle : Real.sqrt ((100001999998000001 / 8000000000000)) ≤
  ...
  have hTcard : T.card = 50 := by
    ...
    rfl
  have hmem_list : ∀ t ∈ xsL, t = x1 ∨ t = x2 ∨ t = x3 ∨ t = x4 ∨ t = x5 ∨ t = x6 ∨ t = x7 ∨ t = x8 ∨ t = x9 ∨ t = x10 ∨ t = x11 ∨ t = x12 ∨ t = x13 ∨ t = x14 ∨ t = x15 ∨ t = x16 ∨ t = x17 ∨ t = x18 ∨ t = x19 ∨ t = x20 ∨ t = x21 ∨ t = x22 ∨ t = x23 ∨ t = x24 ∨ t = x25 ∨ t = x26 ∨ t = x27 ∨ t = x28 ∨ t = x29 ∨ t = x30 ∨ t = x31 ∨ t = x32 ∨ t = x33 ∨ t = x34 ∨ t = x35 ∨ t = x36 ∨ t = x37 ∨ t = x38 ∨ t = x39 ∨ t = x40 ∨ t = x41 ∨ t = x42 ∨ t = x43 ∨ t = x44 ∨ t = x45 ∨ t = x46 ∨ t = x47 ∨ t = x48 ∨ t = x49 ∨ t = x50 := by
    intro t ht
    rw [hxsdef] at ht
    simpa using ht
  ...
  have hTzero : ∀ z ∈ T, riemannZeta z = 0 := by
    ...
    intro t ht
    rcases hmem_list t ht with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
    · exact hzeta _ hΛ1
    · exact hzeta _ hΛ2
    · exact hzeta _ hΛ3
    · exact hzeta _ hΛ4
    ...
    · exact hzeta _ hΛ49
    · exact hzeta _ hΛ50
  have hTbox : ∀ z ∈ T, ((((1 / 2000000)) : ℝ) ≤ z.re ∧ z.re ≤ ((1999999 / 2000000))) ∧ (((100) : ℝ) ≤ z.im ∧ z.im ≤ (200)) := by
    rw [hTdef]
    refine RHInBox.line_toFinset_forall xsL ?_
    intro t ht
    refine ⟨⟨?_, ?_⟩, ?_, ?_⟩
    ...
    · rw [hre_line]; norm_num
    · rw [him_line]
      rcases hmem_list t ht with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl <;> linarith
    · rw [him_line]
      rcases hmem_list t ht with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl <;> linarith
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (100) (200) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((100) : ℝ) (200)) := hE0holo
  ...
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((200) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((100)) ((200))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((100)) ((200))) := by
  ...
  exact RHInBox.rh_in_box_of_certificate (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (100) (200) cPB RPB 50
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d2000000_1999999d2000000_100_200
