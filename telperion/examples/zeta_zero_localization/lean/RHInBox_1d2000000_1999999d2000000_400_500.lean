/-  Per-box instantiation of `RHInBox.rh_in_box_of_certificate` on the box
    `[(1 / 2000000),(1999999 / 2000000)] x [400,500]` with `N = 67` on-line zeros.

    Emitted by telperion `emit_per_box_instantiation` (Task 4 driver `--box`/`--height`).
    Geometry: ball center `c = ((1 / 2)) + (450)*I`, radius `R = Real.sqrt ((820001999998000001 / 8000000000000))`,
...
namespace RHInBox_1d2000000_1999999d2000000_400_500

/-- Chosen Blaschke ball center for the box `[(1 / 2000000),(1999999 / 2000000)] x [400,500]`. -/
noncomputable def cPB : ℂ := ⟨((1 / 2)), (450)⟩

/-- Chosen Blaschke ball radius (squared radius `(820001999998000001 / 8000000000000)`). -/
noncomputable def RPB : ℝ := Real.sqrt ((820001999998000001 / 8000000000000))

theorem RPB_pos : (0 : ℝ) < RPB := Real.sqrt_pos.mpr (by norm_num)

/-- **RH-in-a-box on `[(1 / 2000000),(1999999 / 2000000)] x [400,500]` with `N = 67`.**  Instantiates the generic
    `RHInBox.rh_in_box_of_certificate` at this box's corners, chosen Blaschke ball
    `c = ((1 / 2)) + (450)*I`, `R = Real.sqrt ((820001999998000001 / 8000000000000))`, and count `N = 67`.  Takes the
    documented Arb inputs `hLine` (the 67 on-line zeros) and `hArb` (boundary bundle +
    winding `= 2*pi*I*67`).  conjecture1_proved = False. -/
theorem rh_in_box_1d2000000_1999999d2000000_400_500
    (hLine : ∃ x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21 x22 x23 x24 x25 x26 x27 x28 x29 x30 x31 x32 x33 x34 x35 x36 x37 x38 x39 x40 x41 x42 x43 x44 x45 x46 x47 x48 x49 x50 x51 x52 x53 x54 x55 x56 x57 x58 x59 x60 x61 x62 x63 x64 x65 x66 x67 : ℝ,
    ...
    (hArb : ∀ (E : ℂ → ℂ) (s : Finset ℂ) (d : ℂ → ℤ),
      ...
      ((∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((400) : ℝ) : ℂ) * I))
        ...
        = 2 * π * I * (67 : ℂ))) :
    (∀ ρ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) → (((400) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (500)) →
      riemannZeta ρ = 0 → ρ.re = 1 / 2) := by
  have hRpos : (0 : ℝ) < RPB := RPB_pos
  have hsig : (((1 / 2000000)) : ℝ) ≤ ((1999999 / 2000000)) := by norm_num
  have hTle : ((400) : ℝ) ≤ (500) := by norm_num
  have hbox_ball : ∀ ρ : ℂ, ((((1 / 2000000)) : ℝ) ≤ ρ.re ∧ ρ.re ≤ ((1999999 / 2000000))) →
      (((400) : ℝ) ≤ ρ.im ∧ ρ.im ≤ (500)) → ρ ∈ Metric.ball cPB RPB := by
    intro ρ hre him
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    apply Real.sqrt_lt_sqrt (by positivity)
    have h1 := hre.1; have h2 := hre.2; have h3 := him.1; have h4 := him.2
    nlinarith [h1, h2, h3, h4, sq_nonneg (ρ.re - ((1 / 2))), sq_nonneg (ρ.im - (450))]
  have hs1 : (1 : ℂ) ∉ Metric.ball cPB RPB := by
    rw [Metric.mem_ball, Complex.dist_eq_re_im]
    unfold cPB RPB
    intro hlt
    simp only [Complex.one_re, Complex.one_im] at hlt
    have hle : Real.sqrt ((820001999998000001 / 8000000000000)) ≤
        Real.sqrt (((1 : ℝ) - ((1 / 2))) ^ 2 + ((0 : ℝ) - (450)) ^ 2) :=
      Real.sqrt_le_sqrt (by norm_num)
    linarith [hlt, hle]
  obtain ⟨x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39, x40, x41, x42, x43, x44, x45, x46, x47, x48, x49, x50, x51, x52, x53, x54, x55, x56, x57, x58, x59, x60, x61, x62, x63, x64, x65, x66, x67, ⟨hlo, hc12, hc23, hc34, hc45, hc56, hc67, hc78, hc89, hc910, hc1011, hc1112, hc1213, hc1314, hc1415, hc1516, hc1617, hc1718, hc1819, hc1920, hc2021, hc2122, hc2223, hc2324, hc2425, hc2526, hc2627, hc2728, hc2829, hc2930, hc3031, hc3132, hc3233, hc3334, hc3435, hc3536, hc3637, hc3738, hc3839, hc3940, hc4041, hc4142, hc4243, hc4344, hc4445, hc4546, hc4647, hc4748, hc4849, hc4950, hc5051, hc5152, hc5253, hc5354, hc5455, hc5556, hc5657, hc5758, hc5859, hc5960, hc6061, hc6162, hc6263, hc6364, hc6465, hc6566, hc6667, hhi⟩, hΛ1, hΛ2, hΛ3, hΛ4, hΛ5, hΛ6, hΛ7, hΛ8, hΛ9, hΛ10, hΛ11, hΛ12, hΛ13, hΛ14, hΛ15, hΛ16, hΛ17, hΛ18, hΛ19, hΛ20, hΛ21, hΛ22, hΛ23, hΛ24, hΛ25, hΛ26, hΛ27, hΛ28, hΛ29, hΛ30, hΛ31, hΛ32, hΛ33, hΛ34, hΛ35, hΛ36, hΛ37, hΛ38, hΛ39, hΛ40, hΛ41, hΛ42, hΛ43, hΛ44, hΛ45, hΛ46, hΛ47, hΛ48, hΛ49, hΛ50, hΛ51, hΛ52, hΛ53, hΛ54, hΛ55, hΛ56, hΛ57, hΛ58, hΛ59, hΛ60, hΛ61, hΛ62, hΛ63, hΛ64, hΛ65, hΛ66, hΛ67⟩ := hLine
  ...
  set xsL : List ℝ := [x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39, x40, x41, x42, x43, x44, x45, x46, x47, x48, x49, x50, x51, x52, x53, x54, x55, x56, x57, x58, x59, x60, x61, x62, x63, x64, x65, x66, x67] with hxsdef
  have hchain : xsL.IsChain (· < ·) := by
    rw [hxsdef]
    simp only [List.isChain_cons_cons]
    exact ⟨hc12, hc23, hc34, hc45, hc56, hc67, hc78, hc89, hc910, hc1011, hc1112, hc1213, hc1314, hc1415, hc1516, hc1617, hc1718, hc1819, hc1920, hc2021, hc2122, hc2223, hc2324, hc2425, hc2526, hc2627, hc2728, hc2829, hc2930, hc3031, hc3132, hc3233, hc3334, hc3435, hc3536, hc3637, hc3738, hc3839, hc3940, hc4041, hc4142, hc4243, hc4344, hc4445, hc4546, hc4647, hc4748, hc4849, hc4950, hc5051, hc5152, hc5253, hc5354, hc5455, hc5556, hc5657, hc5758, hc5859, hc5960, hc6061, hc6162, hc6263, hc6364, hc6465, hc6566, hc6667, List.IsChain.singleton _⟩
  set T : Finset ℂ :=
    (xsL.map fun t : ℝ => (1 / 2 : ℂ) + (t : ℂ) * Complex.I).toFinset with hTdef
  have hTcard : T.card = 67 := by
    rw [hTdef, RHInBox.line_toFinset_card xsL hchain, hxsdef]
    rfl
  have hmem_list : ∀ t ∈ xsL, t = x1 ∨ t = x2 ∨ t = x3 ∨ t = x4 ∨ t = x5 ∨ t = x6 ∨ t = x7 ∨ t = x8 ∨ t = x9 ∨ t = x10 ∨ t = x11 ∨ t = x12 ∨ t = x13 ∨ t = x14 ∨ t = x15 ∨ t = x16 ∨ t = x17 ∨ t = x18 ∨ t = x19 ∨ t = x20 ∨ t = x21 ∨ t = x22 ∨ t = x23 ∨ t = x24 ∨ t = x25 ∨ t = x26 ∨ t = x27 ∨ t = x28 ∨ t = x29 ∨ t = x30 ∨ t = x31 ∨ t = x32 ∨ t = x33 ∨ t = x34 ∨ t = x35 ∨ t = x36 ∨ t = x37 ∨ t = x38 ∨ t = x39 ∨ t = x40 ∨ t = x41 ∨ t = x42 ∨ t = x43 ∨ t = x44 ∨ t = x45 ∨ t = x46 ∨ t = x47 ∨ t = x48 ∨ t = x49 ∨ t = x50 ∨ t = x51 ∨ t = x52 ∨ t = x53 ∨ t = x54 ∨ t = x55 ∨ t = x56 ∨ t = x57 ∨ t = x58 ∨ t = x59 ∨ t = x60 ∨ t = x61 ∨ t = x62 ∨ t = x63 ∨ t = x64 ∨ t = x65 ∨ t = x66 ∨ t = x67 := by
    intro t ht
    rw [hxsdef] at ht
    simpa using ht
  ...
  have hTzero : ∀ z ∈ T, riemannZeta z = 0 := by
    ...
    intro t ht
    rcases hmem_list t ht with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
    · exact hzeta _ hΛ1
    · exact hzeta _ hΛ2
    · exact hzeta _ hΛ3
    · exact hzeta _ hΛ4
    ...
    · exact hzeta _ hΛ66
    · exact hzeta _ hΛ67
  have hTbox : ∀ z ∈ T, ((((1 / 2000000)) : ℝ) ≤ z.re ∧ z.re ≤ ((1999999 / 2000000))) ∧ (((400) : ℝ) ≤ z.im ∧ z.im ≤ (500)) := by
    rw [hTdef]
    refine RHInBox.line_toFinset_forall xsL ?_
    intro t ht
    refine ⟨⟨?_, ?_⟩, ?_, ?_⟩
    ...
    · rw [hre_line]; norm_num
    · rw [him_line]
      rcases hmem_list t ht with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl <;> linarith
    · rw [him_line]
      rcases hmem_list t ht with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl <;> linarith
  ...
  obtain ⟨E0, hE0holo, hd1', hzero_in', hker0⟩ :=
    RHInBoxAnalytic.zeta_blaschke_split_ball (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (400) (500) cPB RPB hRpos hbox_ball hs1
  have hE0box : DifferentiableOn ℂ E0 (Set.Icc (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) ×ℂ Set.Icc ((400) : ℝ) (500)) := hE0holo
  ...
  have hwind : (∫ x in (((1 / 2000000)) : ℝ)..((1999999 / 2000000)), logDeriv riemannZeta (↑x + (((400) : ℝ) : ℂ) * I))
        ...
        - I • (∫ y in ((400) : ℝ)..(500), logDeriv riemannZeta (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I))
      = 2 * π * I * ((67 : ℤ) : ℂ) := by
    rw [show (((67 : ℤ) : ℂ)) = (67 : ℂ) by norm_num]; exact hwindA
  have harb : ∀ (E : ℂ → ℂ),
      ...
      (IntervalIntegrable (fun x : ℝ => E (↑x + (((500) : ℝ) : ℂ) * I)) volume (((1 / 2000000))) (((1999999 / 2000000)))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1999999 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((400)) ((500))) ∧
      (IntervalIntegrable (fun y : ℝ => E (((((1 / 2000000)) : ℝ) : ℂ) + ↑y * I)) volume ((400)) ((500))) := by
  ...
  have hcountN : (67 : ℤ) = (T.card : ℤ) := by rw [hTcard]; norm_num
  exact RHInBox.rh_in_box_of_certificate (((1 / 2000000)) : ℝ) ((1999999 / 2000000)) (400) (500) cPB RPB 67
    hRpos hsig hTle hbox_ball hs1 T hTline hTzero hTbox hwind harb hcountN

end RHInBox_1d2000000_1999999d2000000_400_500
