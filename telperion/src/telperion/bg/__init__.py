"""telperion.bg: the Brualdi-Goldwasser research-lab modules.

These are problem-specific probes and certificates extracted from the BG
campaign. They are NOT part of the general engine; the engine (telperion.*)
imports none of them (enforced by tests/test_core_boundary.py). This
namespace re-exports the core engine too, so it is a strict superset.
"""
from telperion import *  # noqa: F401,F403 -- core engine (superset)
from telperion import __version__  # noqa: F401
